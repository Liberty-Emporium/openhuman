...
const messages: TranslationMap = {
  ...
  'skills.explorer.emptyDescription':
    'SKILL.md पैकेज इंस्टॉल करें या Hermes-शैली फ़ोल्डर ~/.alexanderai/skills में रखें।',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'macOS पर, दोनों मोड में ~/.alexanderai सैंडबॉक्स द्वारा सुरक्षित रहता है।',
  ...
  'skills.create.scopeUserHint':
    '~/.alexanderai/skills/<slug>/SKILL.md में लिखा जाता है — सभी वर्कस्पेस में उपलब्ध।',
  ...
  'skills.install.errors.writeFailedHint':
    'कार्यक्षेत्र कौशल निर्देशिका लिखने योग्य नहीं थी. `<workspace>/.alexanderai/skills/` के लिए फ़ाइल सिस्टम अनुमतियाँ जाँचें।',
