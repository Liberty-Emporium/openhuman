...
const messages: TranslationMap = {
  ...
  'skills.explorer.emptyDescription':
    'একটি SKILL.md প্যাকেজ ইনস্টল করুন বা Hermes-ধাঁচের ফোল্ডার ~/.alexanderai/skills-এ রাখুন।',
  ...
  'settings.ai.claudeCode.sandboxNoteMac':
    'macOS-এ, উভয় মোডেই ~/.alexanderai স্যান্ডবক্স দ্বারা সুরক্ষিত থাকে।',
  ...
  'skills.create.scopeUserHint':
    '~/.alexanderai/skills/<slug>/SKILL.md-এ লেখা — সব ওয়ার্কস্পেসে পাওয়া যায়।',
  ...
  'skills.install.errors.writeFailedHint':
    'ওয়ার্কস্পেস দক্ষতা ডিরেক্টরি লেখার যোগ্য ছিল না। `<workspace>/.alexanderai/skills/`-এর জন্য ফাইল সিস্টেমের অনুমতি পরীক্ষা করুন।',
