...
use alexander_ai_solutions_core::alexander_ai_solutions::memory_sources::status::{
    source_status, FreshnessLabel,
};
...
use alexander_ai_solutions_core::alexander_ai_solutions::memory_sync::{
    SyncOutcome, SyncPipelineKind,
};
use alexander_ai_solutions_core::alexander_ai_solutions::memory_tree::summarise::{
    fallback_summary, SummaryContext, SummaryInput,
};
use alexander_ai_solutions_core::alexander_ai_solutions::memory_tree::tree_runtime::store as tree_store;
...
fn tree_node(namespace: &str, node_id: &str, summary: &str) -> TreeNode {
    ...
    TreeNode {
        ...
        parent_id: alexander_ai_solutions_core::alexander_ai_solutions::memory_tree::tree_runtime::derive_parent_id(node_id),
...
fn memory_tree_types_and_fallback_summary_cover_budget_and_legacy_parse_paths() {
    ...
    let ctx = SummaryContext {
        ...
        tree_kind: alexander_ai_solutions_core::alexander_ai_solutions::memory_store::trees::types::TreeKind::Global,
        target_level: 2,
        token_budget: 128,
    };
