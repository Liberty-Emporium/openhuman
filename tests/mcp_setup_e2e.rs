...
use alexander_ai_solutions_core::alexander_ai_solutions::mcp_registry::setup::{self, SecretRef};
...
async fn test_connection_against_stub_returns_tools() {
    use alexander_ai_solutions_core::alexander_ai_solutions::mcp_client::McpStdioClient;
