...
//! [`crate::alexander_ai_solutions::agent::bus::mock_agent_run_turn`]) compose on top of
...
/// [`crate::alexander_ai_solutions::agent::bus::use_real_agent_handler`] that need the
...
/// conveniences (e.g.
/// [`crate::alexander_ai_solutions::agent::bus::mock_agent_run_turn`]) should compose
