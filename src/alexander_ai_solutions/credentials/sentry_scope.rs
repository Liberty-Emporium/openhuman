...
//! [`peek_cached_current_user_identity`](crate::alexander_ai_solutions::app_state::peek_cached_current_user_identity),
...
/// backend-mode sessions, [`crate::alexander_ai_solutions::credentials::core::LOCAL_SESSION_USER_ID`]
