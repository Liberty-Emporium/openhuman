...
use crate::alexander_ai_solutions::config::{AutoJoinPolicy, AutoSummarizePolicy, Config};
...
pub async fn get_search_settings() -> Result<RpcOutcome<serde_json::Value>, String> {
    ...
    let result = serde_json::json!({
        ...
        "effective_engine": match config.search.effective_engine() {
            crate::alexander_ai_solutions::config::SearchEngine::Disabled => "disabled",
            crate::alexander_ai_solutions::config::SearchEngine::Managed => "managed",
            crate::alexander_ai_solutions::config::SearchEngine::Parallel => "parallel",
            crate::alexander_ai_solutions::config::SearchEngine::Brave => "brave",
            crate::alexander_ai_solutions::config::SearchEngine::Querit => "querit",
        },
...
/// cron job via [`crate::alexander_ai_solutions::cron::seed::seed_proactive_agents`].
pub async fn set_onboarding_completed(value: bool) -> Result<RpcOutcome<bool>, String> {
    ...
    if value && !was_completed {
        ...
        tokio::task::spawn_blocking(move || {
            if let Err(e) =
                crate::alexander_ai_solutions::cron::seed::seed_proactive_agents(&seed_config)
            {
