...
pub async fn get_sandbox_settings() -> Result<RpcOutcome<serde_json::Value>, String> {
    ...
    let backend_str = match sandbox.backend {
        crate::alexander_ai_solutions::config::SandboxBackend::Auto => "auto",
        crate::alexander_ai_solutions::config::SandboxBackend::Landlock => "landlock",
        crate::alexander_ai_solutions::config::SandboxBackend::Firejail => "firejail",
        crate::alexander_ai_solutions::config::SandboxBackend::Bubblewrap => "bubblewrap",
        crate::alexander_ai_solutions::config::SandboxBackend::Docker => "docker",
        crate::alexander_ai_solutions::config::SandboxBackend::None => "none",
    };
    ...
    let value = serde_json::json!({
        ...
        "env_passthrough": crate::alexander_ai_solutions::sandbox::ops::SANDBOX_ENV_PASSTHROUGH,
    });
...
pub async fn apply_sandbox_settings(
    ...
    if let Some(ref backend) = update.backend {
        config.sandbox.backend = match backend.as_str() {
            "auto" => crate::alexander_ai_solutions::config::SandboxBackend::Auto,
            "landlock" => crate::alexander_ai_solutions::config::SandboxBackend::Landlock,
            "firejail" => crate::alexander_ai_solutions::config::SandboxBackend::Firejail,
            "bubblewrap" => crate::alexander_ai_solutions::config::SandboxBackend::Bubblewrap,
            "docker" => crate::alexander_ai_solutions::config::SandboxBackend::Docker,
            "none" => crate::alexander_ai_solutions::config::SandboxBackend::None,
            other => {
