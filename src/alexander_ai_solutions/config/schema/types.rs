...
pub struct ModelRegistryEntry {
    ...
    /// for known vendor models from [`crate::alexander_ai_solutions::cost::catalog`].
    #[serde(default)]
    ...
    /// vendor models from [`crate::alexander_ai_solutions::cost::catalog`].
    #[serde(default)]
...
pub struct Config {
    ...
    /// migration under [`crate::alexander_ai_solutions::migrations`] runs successfully.
    ...
    /// [`crate::alexander_ai_solutions::scheduler_gate`].
    #[serde(default)]
    ...
    /// [`crate::alexander_ai_solutions::context::ContextManager`].
    #[serde(default)]
    ...
    /// See [`crate::alexander_ai_solutions::task_sources`].
    #[serde(default)]
    ...
    #[serde(default)]
    pub memory_sources:
        Vec<crate::alexander_ai_solutions::memory_sources::types::MemorySourceEntry>,
    ...
    #[serde(default)]
    pub agent_registry: crate::alexander_ai_solutions::agent_registry::types::AgentRegistryConfig,
    ...
    #[serde(default)]
    pub voice_providers:
        Vec<crate::alexander_ai_solutions::config::schema::voice_providers::VoiceProviderCreds>,
    ...
    /// [`crate::alexander_ai_solutions::config::schema::MeetConfig`]).
    #[serde(default)]
    pub meet: MeetConfig,
...
impl Default for Config {
    fn default() -> Self {
        let openhuman_dir = crate::alexander_ai_solutions::config::default_root_openhuman_dir()
            .unwrap_or_else(|_| {
        ...
        Self {
            ...
            action_dir: crate::alexander_ai_solutions::config::default_action_dir(),
            ...
            agent_registry:
                crate::alexander_ai_solutions::agent_registry::types::AgentRegistryConfig::default(),
