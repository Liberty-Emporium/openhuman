...
pub struct ChannelsConfig {
    ...
    pub yuanbao: Option<crate::alexander_ai_solutions::channels::providers::yuanbao::YuanbaoConfig>,
    ...
    /// handler in [`crate::alexander_ai_solutions::channels::proactive`] always
...
impl ChannelsConfig {
    /// Whether [`crate::alexander_ai_solutions::channels::start_channels`] has any integrations to listen on.
