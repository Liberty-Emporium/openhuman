...
use crate::alexander_ai_solutions::context::session_memory::SessionMemoryConfig;
...
pub struct ContextConfig {
    /// Master switch. When `false`, [`crate::alexander_ai_solutions::context::ContextManager`]
...
fn default_microcompact_keep_recent() -> usize {
    crate::alexander_ai_solutions::context::DEFAULT_KEEP_RECENT_TOOL_RESULTS
}
