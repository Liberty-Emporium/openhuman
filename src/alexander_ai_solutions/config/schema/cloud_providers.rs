...
//! `"my-deepseek"`). The factory in `crate::alexander_ai_solutions::inference::provider::factory`
...
/// [`crate::alexander_ai_solutions::inference::provider::ops::list_configured_models`]
