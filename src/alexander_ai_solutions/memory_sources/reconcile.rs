...
use crate::alexander_ai_solutions::memory_sources::registry;
use crate::alexander_ai_solutions::memory_sources::types::{MemorySourceEntry, SourceKind};
use crate::alexander_ai_solutions::memory_sync::composio;
    ...
    for source in sources.iter_mut() {
        match source.kind {
            ...
            _ => {
                ...
                crate::alexander_ai_solutions::memory_sources::rpc::apply_kind_defaults(source);
            }
        }
    }
    applied
