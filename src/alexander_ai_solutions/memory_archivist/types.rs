...
/// One per-turn capture record persisted by [`crate::alexander_ai_solutions::memory_archivist::store::record_turn`].
...
/// tool-call payload when present; [`crate::alexander_ai_solutions::memory_archivist::clean_conversation`]
