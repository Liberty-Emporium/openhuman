...
use crate::alexander_ai_solutions::agent_experience::store::{
    AgentExperienceStore, ExperienceQuery,
};
use crate::alexander_ai_solutions::agent_experience::types::{AgentExperience, ExperienceHit};
...
async fn open_store() -> Result<AgentExperienceStore, String> {
    let client = match crate::alexander_ai_solutions::memory::global::client_if_ready() {
        Some(client) => client,
        None => {
