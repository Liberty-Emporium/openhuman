...
use crate::alexander_ai_solutions::context::prompt::{PromptContext, PromptSection};
use anyhow::Result;
...
impl LearnedContextSection {
    pub fn new(_memory: std::sync::Arc<dyn crate::alexander_ai_solutions::memory::Memory>) -> Self {
...
pub fn load_learned_from_cache(
    cache: &crate::alexander_ai_solutions::learning::cache::FacetCache,
) -> Vec<String> {
    ...
    use crate::alexander_ai_solutions::memory_store::profile::ProfileFacet;
    ...
    'outer: for indices in by_class.values() {
        for &idx in indices {
            ...
            let pinned = if f.user_state
                == crate::alexander_ai_solutions::memory_store::profile::UserState::Pinned
            {
                " *(pinned)*"
            } else {
                ""
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::context::prompt::LearnedContextData;
    ...
    fn prompt_context(learned: LearnedContextData) -> PromptContext<'static> {
        ...
        PromptContext {
            ...
            visible_tool_names,
            tool_call_format:
                crate::alexander_ai_solutions::context::prompt::ToolCallFormat::PFormat,
    ...
    fn load_learned_from_cache_formats_active_facets() {
        ...
        use crate::alexander_ai_solutions::memory_store::profile::{
    ...
    fn load_learned_from_cache_empty_when_no_active_facets() {
        use crate::alexander_ai_solutions::learning::cache::FacetCache;
        use crate::alexander_ai_solutions::memory_store::profile::PROFILE_INIT_SQL;
        use parking_lot::Mutex;
        use rusqlite::Connection;
