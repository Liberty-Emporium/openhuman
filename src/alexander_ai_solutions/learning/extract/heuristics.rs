...
//!
//! Three detectors feed [`crate::alexander_ai_solutions::learning::candidate::global()`]:
//!
...
//! intended to be called from [`crate::alexander_ai_solutions::learning::ReflectionHook`] or a
...
mod heuristics_tests {
    use super::*;
    use crate::alexander_ai_solutions::learning::candidate::{Buffer, FacetClass};
