...
//! valid candidates to [`crate::alexander_ai_solutions::learning::candidate::global()`].
//!
//! ## Provenance contract
//!
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::learning::candidate::{Buffer, CueFamily, FacetClass};
