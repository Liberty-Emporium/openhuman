...
pub async fn autocomplete_history(
    ...
    let entries =
        crate::alexander_ai_solutions::autocomplete::history::list_history(requested_limit).await?;
...
pub async fn autocomplete_clear_history(
    ...
    let cleared = crate::alexander_ai_solutions::autocomplete::history::clear_history().await?;
    Ok(RpcOutcome::new(
