...
use crate::alexander_ai_solutions::workflows::{preflight, registry, run_log};
...
pub async fn spawn_workflow_run_background(
    ...
    let guidelines = match &skill.definition.system_prompt {
        crate::alexander_ai_solutions::agent::harness::definition::PromptSource::Inline(s) => {
            s.clone()
        }
        _ => String::new(),
    };
    ...
    let inherited_origin = crate::alexander_ai_solutions::agent::turn_origin::current()
        .unwrap_or(crate::alexander_ai_solutions::agent::turn_origin::AgentTurnOrigin::Cli);
    {
        ...
        tokio::spawn(async move {
            ...
            let result = tokio::select! {
                ...
                r = crate::alexander_ai_solutions::agent::turn_origin::with_origin(
                    inherited_origin,
