...
//! "goals" concepts:
//!
//! - [`memory_goals`](crate::alexander_ai_solutions::memory_goals) — a *global*, long-term
//!   list of the user's durable goals (`MEMORY_GOALS.md`).
//! - the per-thread kanban [task board](crate::alexander_ai_solutions::agent::task_board) —
