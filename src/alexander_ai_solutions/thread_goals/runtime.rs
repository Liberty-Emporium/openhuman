...
use crate::alexander_ai_solutions::agent::stop_hooks::{StopDecision, StopHook, TurnState};
...
fn is_goal_continuation_turn() -> bool {
    matches!(
        crate::alexander_ai_solutions::agent::turn_origin::current(),
        Some(
            crate::alexander_ai_solutions::agent::turn_origin::AgentTurnOrigin::TrustedAutomation {
                source:
                    crate::alexander_ai_solutions::agent::turn_origin::TrustedAutomationSource::GoalContinuation,
                ..
            }
        )
    )
...
mod tests {
    ...
    use crate::alexander_ai_solutions::inference::provider::UsageInfo;
