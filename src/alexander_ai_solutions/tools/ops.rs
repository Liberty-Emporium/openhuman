...
use crate::alexander_ai_solutions::agent::host_runtime::{NativeRuntime, RuntimeAdapter};
use crate::alexander_ai_solutions::config::{Config, DelegateAgentConfig};
use crate::alexander_ai_solutions::javascript::NodeBootstrap;
use crate::alexander_ai_solutions::memory::Memory;
use crate::alexander_ai_solutions::runtime_python::PythonBootstrap;
use crate::alexander_ai_solutions::security::{AuditLogger, SecurityPolicy};
...
pub fn all_tools(
    ...
    browser_config: &crate::alexander_ai_solutions::config::BrowserConfig,
    http_config: &crate::alexander_ai_solutions::config::HttpRequestConfig,
    action_dir: &std::path::Path,
    agents: &HashMap<String, DelegateAgentConfig>,
    root_config: &crate::alexander_ai_solutions::config::Config,
) -> Vec<Box<dyn Tool>> {
...
pub fn all_tools_with_runtime(
    ...
    let mut tools: Vec<Box<dyn Tool>> = vec![
        ...
        Box::new(crate::alexander_ai_solutions::plan_review::RequestPlanReviewTool::new()),
        ...
        Box::new(crate::alexander_ai_solutions::tokenjuice::TokenjuiceRetrieveTool::new()),
    ...
    tools.push(Box::new(
        crate::alexander_ai_solutions::memory_diff::MemoryDiffTool,
    ));

    // Subconscious user-facing handoff — notify_user proactive delivery.
    tools.extend(crate::alexander_ai_solutions::subconscious::user_thread::all_user_thread_tools());
    ...
    let tinyplace_tools =
        crate::alexander_ai_solutions::tinyplace::tools::all_tinyplace_agent_tools();
    log::debug!(
    ...
    // allowlist); also available to the main agent for explicit edits.
    {
        ...
        tools.push(Box::new(
            crate::alexander_ai_solutions::memory_goals::GoalsListTool::new(goals_dir.clone()),
        ));
        tools.push(Box::new(
            crate::alexander_ai_solutions::memory_goals::GoalsAddTool::new(goals_dir.clone()),
        ));
        tools.push(Box::new(
            crate::alexander_ai_solutions::memory_goals::GoalsEditTool::new(goals_dir.clone()),
        ));
        tools.push(Box::new(
            crate::alexander_ai_solutions::memory_goals::GoalsDeleteTool::new(goals_dir),
        ));
    }
    ...
    // system-driven and have no model tool.
    {
        ...
        tools.push(Box::new(
            crate::alexander_ai_solutions::thread_goals::GoalGetTool::new(goal_dir.clone()),
        ));
        tools.push(Box::new(
            crate::alexander_ai_solutions::thread_goals::GoalSetTool::new(goal_dir.clone()),
        ));
        tools.push(Box::new(
            crate::alexander_ai_solutions::thread_goals::GoalCompleteTool::new(goal_dir),
        ));
    }
    ...
    tools.push(Box::new(
        crate::alexander_ai_solutions::x402::tools::X402RequestTool::new(),
    ));
    ...
    let mcp_registry = {
        let base =
            crate::alexander_ai_solutions::mcp_client::McpServerRegistry::from_config(root_config);
    ...
    tools.extend(crate::alexander_ai_solutions::search::build_search_tools(
        root_config,
    ));
    ...
    tools.extend(
        crate::alexander_ai_solutions::media_generation::build_media_tools(root_config, action_dir),
    );
    ...
    tools.extend(crate::alexander_ai_solutions::web3::all_web3_agent_tools());
    ...
    if !agents.is_empty() {
        ...
        tools.push(Box::new(DelegateTool::new_with_options(
            delegate_agents,
            security.clone(),
            crate::alexander_ai_solutions::inference::provider::ProviderRuntimeOptions {
    ...
    if let Some(client) = crate::alexander_ai_solutions::integrations::build_client(root_config) {
        tracing::debug!("[integrations] client built successfully");
        if root_config.integrations.apify.is_active() {
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::ApifyRunActorTool::new(Arc::clone(&client)),
            ));
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::ApifyGetRunStatusTool::new(Arc::clone(
                    &client,
                )),
            ));
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::ApifyGetRunResultsTool::new(Arc::clone(
                    &client,
                )),
            ));
        ...
        if root_config.integrations.google_places.is_active() {
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::GooglePlacesSearchTool::new(Arc::clone(
                    &client,
                )),
            ));
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::GooglePlacesDetailsTool::new(Arc::clone(
                    &client,
                )),
            ));
        ...
        if root_config.integrations.stock_prices.is_active() {
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::StockQuoteTool::new(Arc::clone(&client)),
            ));
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::StockExchangeRateTool::new(Arc::clone(
                    &client,
                )),
            ));
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::StockOptionsTool::new(Arc::clone(&client)),
            ));
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::StockCryptoSeriesTool::new(Arc::clone(
                    &client,
                )),
            ));
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::StockCommodityTool::new(Arc::clone(&client)),
            ));
        ...
        if root_config.integrations.twilio.is_active() {
            tools.push(Box::new(
                crate::alexander_ai_solutions::tools::TwilioCallTool::new(Arc::clone(&client)),
            ));
        ...
        let composio_tools =
            crate::alexander_ai_solutions::composio::all_composio_agent_tools(root_config);
    ...
    if crate::alexander_ai_solutions::tools::implementations::lsp_capability_enabled() {
        tools.push(Box::new(
            crate::alexander_ai_solutions::tools::implementations::LspTool::new(),
        ));
