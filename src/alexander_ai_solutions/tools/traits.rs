...
use crate::alexander_ai_solutions::agent::tool_policy::GeneratedToolRuntimeContext;

// Re-export the unified ToolResult from the lightweight skills types module so all tools use one type.
pub use crate::alexander_ai_solutions::workflows::types::{ToolContent, ToolResult};
