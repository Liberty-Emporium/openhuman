use crate::alexander_ai_solutions::mcp_client::{McpRegistrySource, McpServerRegistry};
use crate::alexander_ai_solutions::security::{SecurityPolicy, ToolOperation};
use crate::alexander_ai_solutions::tools::traits::{
    PermissionLevel, Tool, ToolCallOptions, ToolResult,
};
        ...
        let markdown = if servers.is_empty() {
            ...
            for server in self.registry.list() {
                ...
                md.push_str(&format!(
                    ...
                    server.endpoint,
                    match &server.auth {
                        crate::alexander_ai_solutions::config::McpAuthConfig::None => "none",
                        crate::alexander_ai_solutions::config::McpAuthConfig::BearerToken {
                            ..
                        } => "bearer_token",
                        crate::alexander_ai_solutions::config::McpAuthConfig::Basic { .. } =>
                            "basic",
                        crate::alexander_ai_solutions::config::McpAuthConfig::Header { .. } =>
                            "header",
                        crate::alexander_ai_solutions::config::McpAuthConfig::Headers {
                            ..
                        } => "headers",
                        crate::alexander_ai_solutions::config::McpAuthConfig::QueryParam {
                            ..
                        } => "query_param",
                    }
                ));
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::config::{Config, McpServerConfig};
