...
use crate::alexander_ai_solutions::accessibility::ax_interact as ax;
...
pub(crate) fn app_control_enabled(explicit_opt_in: bool) -> bool {
    use crate::alexander_ai_solutions::security::{live_policy, AutonomyLevel};
    explicit_opt_in
        || live_policy::current()
...
mod tests {
    ...
    fn install_live_autonomy(level: crate::alexander_ai_solutions::security::AutonomyLevel) {
        use crate::alexander_ai_solutions::security::{live_policy, SecurityPolicy};
        use std::sync::Arc;
    ...
    async fn refuses_mutations_when_disabled() {
        ...
        let _env = crate::alexander_ai_solutions::config::TEST_ENV_LOCK
            .lock()
            .unwrap_or_else(|e| e.into_inner());
        install_live_autonomy(crate::alexander_ai_solutions::security::AutonomyLevel::Supervised);
