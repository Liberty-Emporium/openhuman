...
//! [`crate::alexander_ai_solutions::javascript::NodeBootstrap`] for binary resolution.
//! Same security posture as
//! [`crate::alexander_ai_solutions::tools::impl::system::shell::ShellTool`] and
//! [`crate::alexander_ai_solutions::tools::impl::system::node_exec::NodeExecTool`]:
//!
...
use crate::alexander_ai_solutions::security::{CommandClass, GateDecision, SecurityPolicy};
...
impl NpmExecTool {
    ...
    async fn run_sandboxed(
        ...
        // finding on PR #3309.)
        let runtime_cfg =
            match crate::alexander_ai_solutions::config::ops::load_config_with_timeout().await {
                Ok(cfg) => cfg.runtime,
                Err(err) => {
                    tracing::warn!(
                        error = %err,
                    ...
                    crate::alexander_ai_solutions::config::RuntimeConfig::default()
                }
            };
