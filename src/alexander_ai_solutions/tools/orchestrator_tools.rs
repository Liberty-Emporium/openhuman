...
//!
//! Called from [`crate::alexander_ai_solutions::agent::harness::session::builder`] at
...
//!
//! [`AgentDefinition::when_to_use`]: crate::alexander_ai_solutions::agent::harness::definition::AgentDefinition::when_to_use
//! [`SubagentEntry::AgentId`]: crate::alexander_ai_solutions::agent::harness::definition::SubagentEntry::AgentId
//! [`SubagentEntry::Skills`]: crate::alexander_ai_solutions::agent::harness::definition::SubagentEntry::Skills

use crate::alexander_ai_solutions::agent::harness::definition::{
    AgentDefinition, AgentDefinitionRegistry, SubagentEntry,
};
use crate::alexander_ai_solutions::context::prompt::ConnectedIntegration;
...
mod tests {
    ...
    fn def(id: &str, when_to_use: &str, delegate_name: Option<&str>) -> AgentDefinition {
        AgentDefinition {
            ...
            agent_tier:
                crate::alexander_ai_solutions::agent::harness::definition::AgentTier::Worker,
