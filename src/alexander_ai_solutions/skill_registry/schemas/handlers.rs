...
use crate::alexander_ai_solutions::skill_registry::ops;
...
pub(super) fn handle_uninstall(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let workflow_params =
            crate::alexander_ai_solutions::workflows::ops_install::UninstallWorkflowParams {
                name: payload.name,
            };
        let outcome = crate::alexander_ai_solutions::workflows::ops_install::uninstall_workflow(
            workflow_params,
            None,
        )?;
        to_json(RpcOutcome::new(
