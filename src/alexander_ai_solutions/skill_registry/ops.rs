...
pub async fn install_from_catalog(
    ...
    crate::alexander_ai_solutions::workflows::ops_install::InstallWorkflowFromUrlOutcome,
    String,
> {
    tracing::info!(
        entry_id = %entry.id,
    ...
    let params =
        crate::alexander_ai_solutions::workflows::ops_install::InstallWorkflowFromUrlParams {
            url: entry.download_url.clone(),
            timeout_secs: Some(60),
        };

    crate::alexander_ai_solutions::workflows::ops_install::install_workflow_from_url(
        workspace_dir,
        params,
    )
    .await
...
mod tests {
    ...
    fn env_lock() -> std::sync::MutexGuard<'static, ()> {
        crate::alexander_ai_solutions::skill_registry::TEST_ENV_LOCK
            .lock()
