...
pub async fn update_settings(
    ...
    use crate::alexander_ai_solutions::config::ops as config_rpc;
    use crate::alexander_ai_solutions::embeddings::format_embedding_signature;
    ...
    if dims_changed {
        ...
        crate::alexander_ai_solutions::memory::read_rpc::wipe_all_rpc(&config)
            .await
