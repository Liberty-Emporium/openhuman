...
//! added by [`crate::alexander_ai_solutions::agent::harness::builtin_definitions::all`] on top of the
//! loader output.
//!
//! Workspace-level overrides (`$OPENHUMAN_WORKSPACE/agents/*.toml`) are
//! handled separately by [`crate::alexander_ai_solutions::agent::harness::definition_loader`] and merged
...
pub struct BuiltinAgent {
    ...
    /// with a populated [`crate::alexander_ai_solutions::agent::harness::definition::PromptContext`]
...
pub const BUILTINS: &[BuiltinAgent] = &[
    ...
    BuiltinAgent {
        ...
        prompt_fn: crate::alexander_ai_solutions::tinyplace::agent::prompt::build,
    },
    BuiltinAgent {
        id: "tools_agent",
    ...
    BuiltinAgent {
        ...
        prompt_fn: crate::alexander_ai_solutions::skill_registry::agent::skill_setup::prompt::build,
    },
    BuiltinAgent {
        id: "skill_executor",
        toml: include_str!("../../skill_runtime/agent/skill_executor/agent.toml"),
        prompt_fn:
            crate::alexander_ai_solutions::skill_runtime::agent::skill_executor::prompt::build,
    },
    BuiltinAgent {
        id: "agent_memory",
        toml: include_str!("../../agent_memory/agent/agent.toml"),
        prompt_fn: crate::alexander_ai_solutions::agent_memory::agent::prompt::build,
    },
    BuiltinAgent {
        id: "subconscious",
        toml: include_str!("../../subconscious/agent/agent.toml"),
        prompt_fn: crate::alexander_ai_solutions::subconscious::agent::prompt::build,
    },
];
...
/// [`crate::alexander_ai_solutions::agent::harness::definition::AgentDefinitionRegistry::load`]
...
mod tests {
    ...
    use crate::alexander_ai_solutions::tokenjuice::AgentTokenjuiceCompression;
    ...
    fn orchestrator_subagents_include_crypto_agent() {
        use crate::alexander_ai_solutions::agent::harness::definition::SubagentEntry;
        let def = find("orchestrator");
    ...
    fn allows_skill_wildcards_on_any_non_worker_tier() {
        ...
        planner.subagents.push(SubagentEntry::Skills(
            crate::alexander_ai_solutions::agent::harness::definition::SkillsWildcard {
                skills: "*".into(),
            },
        ));
