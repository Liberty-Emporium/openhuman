...
use crate::alexander_ai_solutions::tools::orchestrator_tools::sanitise_slug;
use crate::alexander_ai_solutions::workflows::ops_types::Workflow;
use anyhow::Result;
use std::fmt::Write;
...
fn render_connected_mcp_servers() -> String {
    use crate::alexander_ai_solutions::mcp_registry::connections;
...
fn format_connected_mcp_block(
    servers: &[crate::alexander_ai_solutions::mcp_registry::connections::ConnectedServerOverview],
) -> String {
    if servers.is_empty() {
        return String::new();
    }
    ...
    for s in servers {
        ...
        let desc = if desc_raw.is_empty() {
            ...
            crate::alexander_ai_solutions::mcp_client::sanitize::sanitize_for_llm(desc_raw, 240)
                .replace(['\n', '\t'], " ")
                .trim()
                .to_string()
        };
...
mod tests {
    ...
    fn connected_mcp_block_lists_servers_with_description_and_routes_via_delegate() {
        use crate::alexander_ai_solutions::mcp_registry::connections::ConnectedServerOverview;
        use crate::alexander_ai_solutions::mcp_registry::types::McpTool;
