...
use crate::alexander_ai_solutions::council_registry::types::{
...
fn normalize_council(mut council: CouncilDefinition, now_ms: i64) -> CouncilDefinition {
    ...
    while council.seats.len() < council.jury_count {
        ...
        council.seats.push(
            crate::alexander_ai_solutions::council_registry::types::CouncilSeatDefinition {
                id,
    ...
    if council.shared_reasoning.trim().is_empty() {
        council.shared_reasoning =
            crate::alexander_ai_solutions::council_registry::types::DEFAULT_SHARED_REASONING
                .to_string();
    }
