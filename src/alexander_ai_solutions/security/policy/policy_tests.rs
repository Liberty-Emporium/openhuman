...
fn config_default_policy_includes_windows_read_equivalents() {
    let cfg = crate::alexander_ai_solutions::config::AutonomyConfig::default();
...
fn from_config_maps_all_fields() {
    let autonomy_config = crate::alexander_ai_solutions::config::AutonomyConfig {
...
fn expand_tilde_delegates_to_config_single_source_of_truth() {
    ...
    assert_eq!(
        ...
        crate::alexander_ai_solutions::config::expand_tilde(input)
    );
...
fn validate_command_truncates_secrets_in_allowlist_miss_error() {
    ...
    assert!(
        err.starts_with(crate::alexander_ai_solutions::security::POLICY_BLOCKED_MARKER),
...
fn from_config_grants_default_projects_dir_as_readwrite_root() {
    ...
    let projects = crate::alexander_ai_solutions::config::default_projects_dir()
        .to_string_lossy()
        .to_string();
    assert!(
        policy
...
fn from_config_does_not_duplicate_user_granted_projects_root() {
    let projects = crate::alexander_ai_solutions::config::default_projects_dir()
        .to_string_lossy()
        .to_string();
    let cfg = crate::alexander_ai_solutions::config::AutonomyConfig {
