...
//!
//! See [`crate::alexander_ai_solutions::memory_graph`] for the derived co-occurrence
//! query layer built on top of these primitives.

pub use crate::alexander_ai_solutions::memory_tree::score::store::{
...
mod tests {
    ...
    fn entity_hit_reexport_is_constructible() {
        let hit = EntityHit {
            ...
            node_kind: "leaf".into(),
            entity_kind:
                crate::alexander_ai_solutions::memory_tree::score::extract::EntityKind::Person,
            surface: "Alice".into(),
            score: 1.0,
            timestamp_ms: 123,
