...
//! ([`crate::alexander_ai_solutions::memory_store::traits`]), and a delegation in
//! [`crate::alexander_ai_solutions::memory_store::retrieval`].
...
pub mod types {
    pub use crate::alexander_ai_solutions::memory_store::chunks::types::Chunk;
    pub use crate::alexander_ai_solutions::memory_store::entities::EntityHit as Entity;
    pub use crate::alexander_ai_solutions::memory_store::trees::{
        SummaryNode as TreeNode, Tree, TreeKind,
    };
    pub use crate::alexander_ai_solutions::memory_store::types::MemoryKvRecord as Kv;
    pub use crate::alexander_ai_solutions::people::types::Person as Contact;
}
