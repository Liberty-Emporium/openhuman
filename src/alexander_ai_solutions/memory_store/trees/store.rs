...
//! [`crate::alexander_ai_solutions::memory_tree::score::embed::pack_embedding`]. New
...
use crate::alexander_ai_solutions::memory_store::content::StagedSummary;
...
use crate::alexander_ai_solutions::memory_tree::score::embed::{
    decode_optional_blob, pack_checked,
};
...
///
/// Cascade order mirrors [`crate::alexander_ai_solutions::memory_store::chunks::store`]'s
...
/// [`crate::alexander_ai_solutions::memory_store::chunks::store::tree_active_signature`] — same
...
pub fn mark_summary_reembed_skipped(
    ...
    let summary_id =
        crate::alexander_ai_solutions::memory_store::chunks::store::validate_reembed_skip_key(
            "summary_id",
            summary_id,
        )?;
    let model_signature =
...
///
/// Idempotent — see [`crate::alexander_ai_solutions::memory_store::chunks::store::clear_chunk_reembed_skipped`].
