...
use crate::alexander_ai_solutions::config::{
    EmbeddingRouteConfig, MemoryConfig, StorageProviderConfig,
};
use crate::alexander_ai_solutions::embeddings::{
...
use crate::alexander_ai_solutions::memory::traits::Memory;
...
///
/// Delegates to [`crate::alexander_ai_solutions::inference::local::ollama_base_url`] so the probe
...
fn ollama_base_url_for_probe() -> String {
    crate::alexander_ai_solutions::inference::local::ollama_base_url()
}
...
/// [`crate::alexander_ai_solutions::embeddings::resolve_api_key`] (empty string when none is
...
mod tests {
    ...
    impl EnvGuard {
        fn set(value: &str) -> Self {
            let lock = crate::alexander_ai_solutions::inference::local::inference_test_guard();
    ...
    fn embedding_settings_local_overrides_memory_config() {
        ...
        assert_eq!(
            dims,
            crate::alexander_ai_solutions::embeddings::DEFAULT_OLLAMA_DIMENSIONS,
    ...
    fn embedding_settings_local_with_empty_model_uses_default() {
        ...
        assert_eq!(
            model,
            crate::alexander_ai_solutions::embeddings::DEFAULT_OLLAMA_MODEL,
    ...
    fn ollama_health_gate_reports_at_most_once_per_process() {
        let _lock = crate::alexander_ai_solutions::inference::local::inference_test_guard();
        reset_health_gate_for_test();
