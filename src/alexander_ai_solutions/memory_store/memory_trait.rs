...
use crate::alexander_ai_solutions::memory::traits::{
...
use crate::alexander_ai_solutions::memory_store::types::{
    NamespaceDocumentInput, GLOBAL_NAMESPACE,
};
use crate::alexander_ai_solutions::memory_store::unified::fts5;
use anyhow::Context;
    ...
    async fn get(&self, namespace: &str, key: &str) -> anyhow::Result<Option<MemoryEntry>> {
        ...
        Ok(row.map(
            |(id, key, content, updated_at, category, taint_str)| MemoryEntry {
                ...
                session_id: None,
                score: None,
                taint: crate::alexander_ai_solutions::memory::MemoryTaint::from_db_str(&taint_str),
            },
        ))
    }
