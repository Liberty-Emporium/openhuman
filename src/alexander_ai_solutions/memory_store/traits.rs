...
use crate::alexander_ai_solutions::memory_store::chunks::types::Chunk;
use crate::alexander_ai_solutions::memory_store::kinds::MemoryKind;
use crate::alexander_ai_solutions::memory_store::trees::{SummaryNode, Tree};
use crate::alexander_ai_solutions::people::types::Person;
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::memory_store::chunks::types::{Metadata, SourceKind};
    use chrono::Utc;
    ...
    fn summary_node_traits_render_expected_kind_and_path() {
        let node = SummaryNode {
            id: "summary-1".into(),
            tree_id: "tree-1".into(),
            tree_kind: crate::alexander_ai_solutions::memory_store::trees::TreeKind::Source,
            level: 1,
            parent_id: None,
    ...
    fn tree_traits_render_obsidian_metadata() {
        let tree = Tree {
            id: "tree-1".into(),
            kind: crate::alexander_ai_solutions::memory_store::trees::TreeKind::Topic,
            scope: "topic:phoenix".into(),
            root_id: Some("summary-root".into()),
            max_level: 2,
            status: crate::alexander_ai_solutions::memory_store::trees::TreeStatus::Active,
            created_at: Utc::now(),
            last_sealed_at: None,
        };
    ...
    fn person_traits_render_name_and_email_when_present() {
        let now = Utc::now();
        let person = Person {
            id: crate::alexander_ai_solutions::people::types::PersonId::new(),
            display_name: Some("Alice Example".into()),
            primary_email: Some("alice@example.com".into()),
            primary_phone: Some("+1 555 0100".into()),
            handles: vec![
                crate::alexander_ai_solutions::people::types::Handle::DisplayName(
                    "Alice Example".into(),
                ),
                crate::alexander_ai_solutions::people::types::Handle::Email(
