...
use crate::alexander_ai_solutions::embeddings::{self, EmbeddingProvider};
use crate::alexander_ai_solutions::memory::ingestion::queue as ingestion_queue;
...
use crate::alexander_ai_solutions::memory_store::types::{
    NamespaceDocumentInput, NamespaceMemoryHit, NamespaceRetrievalContext,
};
use crate::alexander_ai_solutions::memory_store::unified::UnifiedMemory;
...
/// [`MemoryConfig.embedding_provider`](crate::alexander_ai_solutions::config::MemoryConfig)
/// resolves to — cloud (OpenHuman backend, the default returned by
/// [`crate::alexander_ai_solutions::embeddings::default_embedding_provider`]) or local Ollama
...
/// store via [`crate::alexander_ai_solutions::memory_store::create_memory_with_local_ai`] with the
...
impl MemoryClient {
    ...
    /// [`crate::alexander_ai_solutions::memory_store::unified::profile::profile_upsert`].
    ///
    ...
    pub fn memory_handle(&self) -> Arc<dyn crate::alexander_ai_solutions::memory::Memory> {
        Arc::clone(&self.inner) as Arc<dyn crate::alexander_ai_solutions::memory::Memory>
    }
    ...
    pub fn new_local() -> Result<Self, String> {
        let workspace_dir = crate::alexander_ai_solutions::config::default_root_openhuman_dir()
    ...
    /// [`MemoryTaint::ExternalSync`](crate::alexander_ai_solutions::memory::MemoryTaint::ExternalSync)
    ...
    pub async fn store_skill_sync(
        ...
        let input = NamespaceDocumentInput {
            ...
            taint: crate::alexander_ai_solutions::memory::MemoryTaint::ExternalSync,
        };
