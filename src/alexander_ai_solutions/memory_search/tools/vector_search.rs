...
use crate::alexander_ai_solutions::embeddings::provider_from_config;
use crate::alexander_ai_solutions::memory_search::vector::mmr::{mmr_select, MmrCandidate};
use crate::alexander_ai_solutions::memory_search::vector::store::cosine_similarity;
...
use crate::alexander_ai_solutions::tools::traits::{Tool, ToolResult};
...
impl Tool for MemoryVectorSearchTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let query = ListChunksQuery {
            ...
            until_ms: None,
            limit: Some(1000),
            source_scope: crate::alexander_ai_solutions::memory::source_scope::current_source_scope(
            ),
