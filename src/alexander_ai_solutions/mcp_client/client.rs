use crate::alexander_ai_solutions::config::{McpAuthConfig, McpClientIdentityConfig};
use crate::alexander_ai_solutions::workflows::types::ToolResult;
use anyhow::Context;
use base64::Engine;
...
impl McpRemoteTool {
    ...
    pub fn display_description(&self) -> Option<String> {
        self.description.as_deref().map(|d| {
            crate::alexander_ai_solutions::mcp_client::sanitize::sanitize_for_llm(
                d,
                crate::alexander_ai_solutions::mcp_client::sanitize::MAX_DESCRIPTION_BYTES,
            )
        })
    }
    ...
    /// [`crate::alexander_ai_solutions::mcp_client::sanitize::MAX_TITLE_BYTES`].
