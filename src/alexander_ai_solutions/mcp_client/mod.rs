...
//!    [`crate::alexander_ai_solutions::tools::impl::network::mcp`] (`mcp_list_servers`,
//!    `mcp_list_tools`, `mcp_call_tool`). The bespoke `gitbooks` tool also
//!    consumes [`McpHttpClient`] directly.
//!
//! # Relationship to `mcp_registry`
//!
//! The sibling [`crate::alexander_ai_solutions::mcp_registry`] module owns the *dynamic*,
...
//!   [`crate::alexander_ai_solutions::config::McpClientConfig`]
