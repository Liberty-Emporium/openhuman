...
mod tests {
    ...
    use crate::alexander_ai_solutions::config::McpClientIdentityConfig;
    use crate::alexander_ai_solutions::mcp_client::setup_agent::{
        resolve_setup_request, test_connection,
    };
