...
use crate::alexander_ai_solutions::inference::provider::traits::build_tool_instructions_text;
...
async fn load_config_and_init_registry(
) -> Result<crate::alexander_ai_solutions::config::Config, ToolCallError> {
