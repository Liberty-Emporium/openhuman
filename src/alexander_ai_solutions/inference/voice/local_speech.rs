...
//! pipeline ([`crate::alexander_ai_solutions::inference::paths::resolve_piper_binary`]),
...
//! [`crate::alexander_ai_solutions::inference::local::install_piper`] which downloads the
//! Piper binary archive (`.zip` on Windows, `.tar.gz` on macOS / Linux)
//! into `~/.alexanderai/bin/piper/`, extracts it, and stages the bundled
...
use crate::alexander_ai_solutions::voice::reply_speech::{ReplySpeechResult, VisemeFrame};
