...
use crate::alexander_ai_solutions::inference::provider::openhuman_backend;
...
pub fn is_budget_exhausted_http_400(status: reqwest::StatusCode, body: &str) -> bool {
    status == reqwest::StatusCode::BAD_REQUEST
        && crate::alexander_ai_solutions::inference::provider::is_budget_exhausted_message(body)
}
...
pub fn is_backend_error_code_owned(provider: &str, body: &str) -> bool {
    provider == openhuman_backend::PROVIDER_LABEL
        && crate::alexander_ai_solutions::inference::provider::backend_error_code_skips_sentry(body)
}
...
pub fn log_backend_error_code_owned(
    ...
    let code =
        crate::alexander_ai_solutions::inference::provider::extract_backend_error_code_token(body)
            .unwrap_or_default();
    tracing::info!(
        domain = "llm_provider",
        operation = operation,
...
/// [`crate::alexander_ai_solutions::inference::provider::ChatRequest::max_tokens`]): a 402
...
pub fn is_provider_config_rejection_http(
    ...
    if crate::alexander_ai_solutions::inference::provider::is_openai_compatible_unknown_model_message(body) {
        return true;
    }
...
pub fn log_byo_provider_auth_failure(
    ...
    if crate::alexander_ai_solutions::inference::provider::auth_error_registry::record(
        provider,
        status_code,
    ) {
        crate::core::event_bus::publish_global(
            crate::core::event_bus::DomainEvent::ProviderApiKeyRejected {
                ...
                message:
                    crate::alexander_ai_solutions::inference::provider::auth_error_registry::auth_error_message(
                        provider,
                        status_code,
                    ),
            },
