...
pub struct OpenAiCompatibleProvider {
    ...
    pub(crate) local_provider_kind:
        Option<crate::alexander_ai_solutions::inference::local::profile::LocalProviderKind>,
}
...
impl OpenAiCompatibleProvider {
    ...
    pub fn with_local_provider_kind(
        mut self,
        kind: crate::alexander_ai_solutions::inference::local::profile::LocalProviderKind,
    ) -> Self {
