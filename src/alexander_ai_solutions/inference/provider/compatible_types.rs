...
/// [`crate::alexander_ai_solutions::agent::multimodal`] — the agent harness embeds image
...
pub(crate) struct NativeChatRequest {
    ...
    /// set — see `crate::alexander_ai_solutions::inference::provider::thread_context`).
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// `crate::alexander_ai_solutions::inference::provider::traits::StreamOptions`, which is the
