...
pub(crate) fn is_non_retryable(err: &anyhow::Error) -> bool {
    ...
    if crate::alexander_ai_solutions::inference::provider::body_indicates_quota_exhausted(&msg) {
        return true;
    }
...
impl Provider for ReliableProvider {
    ...
    async fn effective_context_window(&self, model: &str) -> Option<u64> {
        match self.providers.first() {
            ...
            None => crate::alexander_ai_solutions::inference::context_window_for_model(model),
        }
    }
