...
use crate::alexander_ai_solutions::inference::provider::{temperature, thread_context};
...
impl OpenAiCompatibleProvider {
    ...
    pub(super) fn http_client(&self) -> Client {
        if let Some(ua) = self.user_agent.as_deref() {
            ...
            let builder = crate::alexander_ai_solutions::tls::tls_client_builder()
    ...
    pub(super) fn tool_specs_to_openai_format(
        tools: &[crate::alexander_ai_solutions::tools::ToolSpec],
