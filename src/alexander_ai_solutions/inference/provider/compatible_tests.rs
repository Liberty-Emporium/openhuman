...
fn agent_turn_cap_reaches_the_wire() {
    ...
    let cap = crate::alexander_ai_solutions::inference::provider::AGENT_TURN_MAX_OUTPUT_TOKENS;
    assert!(
...
async fn outbound_thread_id_is_gated_per_provider() {
    use crate::alexander_ai_solutions::inference::provider::thread_context::with_thread_id;
...
async fn codex_responses_omits_max_output_tokens() {
    ...
    let request = crate::alexander_ai_solutions::inference::provider::traits::ChatRequest {
        messages: &messages,
        tools: None,
        stream: None,
...
fn prompt_guided_tool_fallback_injects_system_instruction() {
    ...
    let tools = vec![crate::alexander_ai_solutions::tools::ToolSpec {
...
fn tool_specs_convert_to_openai_format() {
    let specs = vec![crate::alexander_ai_solutions::tools::ToolSpec {
...
fn spec(name: &str) -> crate::alexander_ai_solutions::tools::ToolSpec {
    crate::alexander_ai_solutions::tools::ToolSpec {
        name: name.to_string(),
...
async fn stream_chat_with_system_insufficient_balance_402_propagates_error() {
    ...
    use crate::alexander_ai_solutions::inference::provider::traits::{StreamError, StreamOptions};
...
fn prompt_cache_caps_conservative_for_unknown_or_custom_slugs() {
    ...
    let conservative =
        crate::alexander_ai_solutions::inference::provider::traits::PromptCacheCapabilities::default();
