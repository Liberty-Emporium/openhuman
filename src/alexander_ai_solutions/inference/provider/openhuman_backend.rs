...
//! Session material is loaded via [`crate::alexander_ai_solutions::credentials`] (see also [`crate::api::jwt`] for shared helpers).
    ...
    fn state_dir(&self) -> PathBuf {
        self.options.openhuman_dir.clone().unwrap_or_else(|| {
            directories::UserDirs::new()
                ...
                .unwrap_or_else(|| PathBuf::from(".alexanderai"))
        })
    }
