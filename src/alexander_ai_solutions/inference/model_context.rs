...
/// [`crate::alexander_ai_solutions::inference::provider::Provider::loaded_context_window`]
...
pub fn context_window_for_model_with_local_fallback(
    model: &str,
    local_kind: Option<crate::alexander_ai_solutions::inference::local::profile::LocalProviderKind>,
) -> Option<u64> {
    ...
    if let Some(kind) = local_kind {
        let profile =
            crate::alexander_ai_solutions::inference::local::profile::profile_for_kind(kind);
...
/// [`crate::alexander_ai_solutions::inference::provider::Provider::supports_vision`]; this flag
...
///   ([`crate::alexander_ai_solutions::inference::provider::factory::oh_tier_supports_vision`]) —
...
pub fn model_supports_vision(
    ...
    crate::alexander_ai_solutions::inference::provider::factory::oh_tier_supports_vision(model)
