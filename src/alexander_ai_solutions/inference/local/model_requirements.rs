...
//! `num_ctx = 8192` (see
//! [`crate::alexander_ai_solutions::memory_tree::score::embed::ollama::EMBED_NUM_CTX`])
...
pub const MIN_CONTEXT_TOKENS: u64 =
    crate::alexander_ai_solutions::memory_tree::score::embed::ollama::EMBED_NUM_CTX as u64;
