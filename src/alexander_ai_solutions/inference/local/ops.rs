...
use crate::alexander_ai_solutions::inference::local as local_ai;
use crate::alexander_ai_solutions::inference::provider as providers;
use crate::alexander_ai_solutions::inference::provider::ops::ProviderRuntimeOptions;
use crate::alexander_ai_solutions::inference::{
...
pub async fn agent_chat(
    ...
    let run = crate::alexander_ai_solutions::agent::turn_origin::with_origin(
...
pub async fn local_ai_chat(
    ...
    let mut ollama_messages: Vec<
        crate::alexander_ai_solutions::inference::local::ollama::OllamaChatMessage,
