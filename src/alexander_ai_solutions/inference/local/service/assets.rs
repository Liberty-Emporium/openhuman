...
use crate::alexander_ai_solutions::inference::types::{
...
impl LocalAiService {
    pub async fn assets_status(&self, config: &Config) -> Result<LocalAiAssetsStatus, String> {
        ...
        let ollama_available = if uses_ollama_assets {
            let base_url =
                crate::alexander_ai_solutions::inference::local::ollama_base_url_from_config(
                    config,
                );
    ...
    pub(in crate::alexander_ai_solutions::inference::local::service) async fn ensure_stt_asset_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::alexander_ai_solutions::inference::local::service) async fn ensure_tts_asset_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
