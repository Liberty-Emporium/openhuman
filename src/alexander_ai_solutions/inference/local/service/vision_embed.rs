...
use crate::alexander_ai_solutions::inference::types::LocalAiEmbeddingResult;
...
impl LocalAiService {
    pub async fn vision_prompt(
        ...
        let _gate_permit = crate::alexander_ai_solutions::scheduler_gate::wait_for_capacity().await;
