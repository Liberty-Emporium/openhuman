...
use crate::alexander_ai_solutions::inference::local::lm_studio::lm_studio_base_url;
use crate::alexander_ai_solutions::inference::local::model_requirements::{
...
impl LocalAiService {
    ...
    pub(in crate::alexander_ai_solutions::inference::local::service) async fn list_models_at(
        &self,
        base: &str,
    ...
    pub(in crate::alexander_ai_solutions::inference::local::service) async fn fetch_model_show_at(
        &self,
        base_url: &str,
        model: &str,
    ) -> OllamaModelShow {
