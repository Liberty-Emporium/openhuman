...
async fn install_whisper_handler_serializes_concurrent_calls() {
    ...
    // the network in CI.
    let slot = crate::alexander_ai_solutions::inference::local::voice_install_common::try_acquire_install_slot(
    ...
    crate::alexander_ai_solutions::inference::local::voice_install_common::write_status(
        crate::alexander_ai_solutions::inference::local::voice_install_common::VoiceInstallStatus {
            engine: crate::alexander_ai_solutions::inference::local::voice_install_common::ENGINE_WHISPER.to_string(),
            state: crate::alexander_ai_solutions::inference::local::voice_install_common::VoiceInstallState::Installing,
            progress: Some(0),
    ...
    crate::alexander_ai_solutions::inference::local::voice_install_common::reset_status(
        crate::alexander_ai_solutions::inference::local::voice_install_common::ENGINE_WHISPER,
    );
