...
/// Delegates to [`crate::alexander_ai_solutions::screen_intelligence::server::run_standalone`],
...
pub(super) fn run_server(args: &[String]) -> Result<()> {
    ...
    rt.block_on(async {
        ...
        let server_config =
            crate::alexander_ai_solutions::screen_intelligence::server::SiServerConfig {
        ...
        crate::alexander_ai_solutions::screen_intelligence::server::run_standalone(
            config,
            server_config,
        )
        .await
