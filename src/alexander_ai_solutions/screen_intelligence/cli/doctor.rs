...
pub(super) fn run_doctor(args: &[String]) -> Result<()> {
    ...
    rt.block_on(async {
        ...
        let doctor_json =
            crate::alexander_ai_solutions::screen_intelligence::rpc::accessibility_doctor_cli_json()
                .await
        ...
        // Vision config check.
        let config = crate::alexander_ai_solutions::config::Config::load_or_init().await.ok();
