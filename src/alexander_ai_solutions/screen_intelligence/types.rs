use crate::alexander_ai_solutions::config::ScreenIntelligenceConfig;
use serde::{Deserialize, Serialize};

// Permission types are defined in the accessibility middleware; re-export for compatibility.
pub use crate::alexander_ai_solutions::accessibility::{GlobeHotkeyPollResult, GlobeHotkeyStatus};
pub use crate::alexander_ai_solutions::accessibility::{
