...
pub struct StartSessionRequest {
    ...
    /// bot. Used by the wake-word gate in [`crate::alexander_ai_solutions::meet_agent::session`]
...
pub struct StopSessionResponse {
    ...
    /// for telemetry and the smoke test in [`crate::alexander_ai_solutions::meet_agent`].
