...
/// `crate::alexander_ai_solutions::memory_tree::score::extract::EntityKind` so the
...
pub fn persist_provider_profile(profile: &ProviderUserProfile) -> usize {
    let Some(client) = crate::alexander_ai_solutions::memory::global::client_if_ready() else {
        tracing::debug!(
