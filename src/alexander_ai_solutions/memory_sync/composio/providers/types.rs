...
use crate::alexander_ai_solutions::composio::types::ComposioExecuteResponse;
...
/// migration in [`crate::alexander_ai_solutions::composio::tools::ComposioExecuteTool`].
...
/// [`crate::alexander_ai_solutions::memory_sync::composio::run_connection_sync`] returns
...
impl ProviderContext {
    ...
    pub fn memory_client(
        &self,
    ) -> Option<crate::alexander_ai_solutions::memory_store::MemoryClientRef> {
        #[cfg(test)]
        {
            return crate::alexander_ai_solutions::memory_store::MemoryClient::from_workspace_dir(
        ...
        #[cfg(not(test))]
        crate::alexander_ai_solutions::memory::global::client_if_ready()
    }
}
