...
//!
//! The sibling [`crate::alexander_ai_solutions::composio`] domain still owns auth,
...
use crate::alexander_ai_solutions::composio::types::ComposioConnection;
...
pub async fn list_sync_targets(config: &Config) -> Result<Vec<SyncTarget>, String> {
    ...
    let registry_sources = crate::alexander_ai_solutions::memory_sources::list_enabled_by_kind(
        crate::alexander_ai_solutions::memory_sources::SourceKind::Composio,
    )
    .await
    .unwrap_or_default();
