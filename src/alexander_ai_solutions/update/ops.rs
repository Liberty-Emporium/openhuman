...
use crate::alexander_ai_solutions::config::{self, UpdateConfig, UpdateRestartStrategy};
use crate::alexander_ai_solutions::update;
use crate::alexander_ai_solutions::update::types::{
    ...
    match restart_strategy {
        UpdateRestartStrategy::SelfReplace => {
            let restart_requested =
                match crate::alexander_ai_solutions::service::rpc::service_restart(
