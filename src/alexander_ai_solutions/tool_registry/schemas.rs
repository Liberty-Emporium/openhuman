...
fn handle_list(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::alexander_ai_solutions::tool_registry::ops::list_tools())
    })
}
...
fn handle_get(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        to_json(crate::alexander_ai_solutions::tool_registry::ops::get_tool(
            tool_id,
        )?)
    })
}
...
fn handle_diagnostics(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let result = crate::alexander_ai_solutions::tool_registry::ops::diagnostics()
            .await
            .and_then(to_json);
        log::debug!(
