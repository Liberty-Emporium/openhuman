...
//! [`crate::alexander_ai_solutions::people::rpc`] (which returns `RpcOutcome`) or to
...
use crate::alexander_ai_solutions::people::rpc;
use crate::alexander_ai_solutions::people::store::{self, PeopleStore};
use crate::alexander_ai_solutions::people::types::{Handle, Interaction, PersonId};
