...
use crate::alexander_ai_solutions::people::address_book::{self, AddressBookError, ContactsSource};
use crate::alexander_ai_solutions::people::store::PeopleStore;
use crate::alexander_ai_solutions::people::types::{Handle, Person, PersonId};
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::people::address_book::tests::MockContactsSource;
    use crate::alexander_ai_solutions::people::types::AddressBookContact;
