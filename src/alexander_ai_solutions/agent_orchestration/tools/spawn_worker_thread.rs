...
use crate::alexander_ai_solutions::agent::harness::fork_context::current_parent;
use crate::alexander_ai_solutions::agent::harness::subagent_runner::{
    run_subagent, SubagentRunOptions,
};
use crate::alexander_ai_solutions::memory_conversations::{self as conversations};
use crate::alexander_ai_solutions::tools::traits::{PermissionLevel, Tool, ToolResult};
...
impl Tool for SpawnWorkerThreadTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let current_thread_id =
            crate::alexander_ai_solutions::inference::provider::thread_context::current_thread_id()
...
mod tests {
    ...
    use crate::alexander_ai_solutions::agent::harness::ParentExecutionContext;
    use crate::alexander_ai_solutions::memory_conversations::CreateConversationThread;
    ...
    struct MockProvider;
    #[async_trait]
    impl crate::alexander_ai_solutions::inference::provider::Provider for MockProvider {
        ...
        async fn chat(
            &self,
            _: crate::alexander_ai_solutions::inference::provider::ChatRequest<'_>,
            _: &str,
            _: f64,
        ) -> anyhow::Result<crate::alexander_ai_solutions::inference::provider::ChatResponse>
        {
            Ok(
    ...
    struct MockMemory;
    #[async_trait]
    impl crate::alexander_ai_solutions::memory::Memory for MockMemory {
        async fn store(
            &self,
            _: &str,
            _: &str,
            _: &str,
            _: crate::alexander_ai_solutions::memory::MemoryCategory,
            _: Option<&str>,
        ) -> anyhow::Result<()> {
            Ok(())
        }
        async fn recall(
            ...
            _: &str,
            _: usize,
            _: crate::alexander_ai_solutions::memory::RecallOpts<'_>,
        ...
        async fn list(
            &self,
            _: Option<&str>,
            _: Option<&crate::alexander_ai_solutions::memory::MemoryCategory>,
            _: Option<&str>,
        ) -> anyhow::Result<Vec<crate::alexander_ai_solutions::memory::MemoryEntry>> {
            Ok(vec![])
        }
    ...
    fn test_parent_ctx(workspace_dir: PathBuf) -> ParentExecutionContext {
        ParentExecutionContext {
            ...
            tool_call_format:
                crate::alexander_ai_solutions::context::prompt::ToolCallFormat::Native,
        }
    }
    ...
    async fn rejects_if_already_worker_thread() {
        ...
        crate::alexander_ai_solutions::inference::provider::thread_context::with_thread_id(
            thread_id.to_string(),
            async {
