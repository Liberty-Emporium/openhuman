...
use crate::alexander_ai_solutions::agent::harness::definition::{
    AgentDefinition, AgentDefinitionRegistry,
};
...
use crate::alexander_ai_solutions::file_state;
...
impl Tool for SpawnParallelAgentsTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let action_root: Option<std::path::PathBuf> =
            crate::alexander_ai_solutions::config::Config::load_or_init()
                .await
                .ok()
        ...
        for task in tasks {
            ...
            let worktree_path = if wants_worktree {
                use crate::alexander_ai_solutions::agent_orchestration::worktree;
        ...
        let per_worker: Vec<(String, Vec<std::path::PathBuf>)> = results
            ...
            .collect();
        let overlaps =
            crate::alexander_ai_solutions::agent_orchestration::worktree::detect_overlaps(
                &per_worker,
            );
