...
//!
//! See [`crate::alexander_ai_solutions::channels::runtime::dispatch`] for the primary
//! caller.
...
use crate::alexander_ai_solutions::agent::turn_origin::{self, AgentTurnOrigin};
use crate::alexander_ai_solutions::config::MultimodalConfig;
...
pub struct AgentTurnRequest {
    ...
    pub multimodal_files: crate::alexander_ai_solutions::config::MultimodalFileConfig,
    ...
    /// [`AGENT_TURN_ORIGIN`](crate::alexander_ai_solutions::agent::turn_origin::AGENT_TURN_ORIGIN)
...
///
/// ```ignore
/// use crate::alexander_ai_solutions::agent::bus::{mock_agent_run_turn, AgentTurnResponse};
