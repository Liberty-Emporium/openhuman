...
use crate::alexander_ai_solutions::agent::harness::tool_loop::run_tool_call_loop;
use crate::alexander_ai_solutions::context::guard::{ContextCheckResult, ContextGuard};
use crate::alexander_ai_solutions::inference::provider::traits::ProviderCapabilities;
use crate::alexander_ai_solutions::inference::provider::Provider;
use crate::alexander_ai_solutions::inference::provider::{
    ChatMessage, ChatRequest, ChatResponse, UsageInfo,
};
use crate::alexander_ai_solutions::tool_timeout::parse_tool_timeout_secs;
use crate::alexander_ai_solutions::tools::{Tool, ToolResult};
...
fn multimodal_cfg() -> crate::alexander_ai_solutions::config::MultimodalConfig {
    crate::alexander_ai_solutions::config::MultimodalConfig::default()
}

fn multimodal_file_cfg() -> crate::alexander_ai_solutions::config::MultimodalFileConfig {
...
async fn full_turn_cycle_user_llm_tool_result_final() {
    ...
    let result = run_tool_call_loop(
        ...
        None,
        None,
        &crate::alexander_ai_solutions::tools::policy::DefaultToolPolicy,
    )
    .await
...
async fn max_iterations_exceeded_downcasts_to_typed_agent_error() {
    ...
    assert!(
        crate::alexander_ai_solutions::agent::error::is_max_iterations_error(&err.to_string()),
...
fn parse_tool_calls_invoke_tag_with_json_body() {
    use crate::alexander_ai_solutions::agent::harness::parse::parse_tool_calls;
...
fn current_datetime_line_matches_iso8601_date_and_utc_offset_pattern() {
    ...
    let payload = crate::alexander_ai_solutions::agent::prompts::current_datetime_line();
...
fn datetime_section_is_static_grounding_rule_not_a_volatile_timestamp() {
    use crate::alexander_ai_solutions::agent::prompts::{
        DateTimeSection, PromptContext, PromptSection,
    };
    use std::collections::HashSet;
    use std::path::Path;
    ...
    static EMPTY_TOOLS: &[crate::alexander_ai_solutions::agent::prompts::PromptTool<'static>] = &[];
    static EMPTY_INTEGRATIONS:
    ...
    let ctx = PromptContext {
        ...
        learned: crate::alexander_ai_solutions::agent::prompts::LearnedContextData::default(),
