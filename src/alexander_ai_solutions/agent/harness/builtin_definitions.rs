...
//! [`crate::alexander_ai_solutions::agent_registry::agents`] — each agent is a subfolder
...
/// [`crate::alexander_ai_solutions::agent_registry::agents`] verify in CI that every entry in
/// [`crate::alexander_ai_solutions::agent_registry::agents::BUILTINS`] still parses cleanly.
///
...
pub fn all() -> Vec<AgentDefinition> {
    #[allow(unused_mut)]
    let mut defs = crate::alexander_ai_solutions::agent_registry::agents::load_builtins()
...
mod tests {
    ...
    fn all_definitions_present() {
        ...
        assert_eq!(
            defs.len(),
            crate::alexander_ai_solutions::agent_registry::agents::BUILTINS.len() + 3
        );
    }
