...
fn mm() -> crate::alexander_ai_solutions::config::MultimodalConfig {
    crate::alexander_ai_solutions::config::MultimodalConfig::default()
}

fn mff() -> crate::alexander_ai_solutions::config::MultimodalFileConfig {
...
async fn orchestrator_prompt_drives_composio_call_via_delegation_chain() {
    use crate::alexander_ai_solutions::agent::prompts::types::ConnectedIntegration;
    use crate::alexander_ai_solutions::agent_registry::agents::orchestrator::prompt as orch_prompt;
    use crate::alexander_ai_solutions::composio::ComposioActionTool;
    use crate::alexander_ai_solutions::config::TEST_ENV_LOCK;
    ...
    let ctx = {
        use crate::alexander_ai_solutions::context::prompt::{LearnedContextData, ToolCallFormat};
        use std::collections::HashSet;
        use std::sync::OnceLock;
        static EMPTY: OnceLock<HashSet<String>> = OnceLock::new();
        crate::alexander_ai_solutions::context::prompt::PromptContext {
