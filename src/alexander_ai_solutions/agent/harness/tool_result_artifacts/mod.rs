...
use crate::alexander_ai_solutions::agent::dispatcher::ToolExecutionResult;
use crate::alexander_ai_solutions::context::{apply_tool_result_budget, BudgetOutcome};
use crate::alexander_ai_solutions::memory_store::safety::{sanitize_text, SanitizationReport};
...
fn bound_text_to_budget(content: String, budget_bytes: usize) -> (String, usize) {
    ...
    let cut = crate::alexander_ai_solutions::util::floor_char_boundary(&output, budget_bytes);
    output.truncate(cut);
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::security::{AutonomyLevel, SecurityPolicy};
    use crate::alexander_ai_solutions::tools::traits::Tool;
    use crate::alexander_ai_solutions::tools::FileReadTool;
    use serde_json::json;
    use std::sync::Arc;
