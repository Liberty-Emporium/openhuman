...
use super::*;
use crate::alexander_ai_solutions::agent::harness::engine::progress::NullProgress;
...
use crate::alexander_ai_solutions::context::EngineAutocompact;
use crate::alexander_ai_solutions::inference::provider::{ChatResponse, ToolCall, UsageInfo};
...
struct NoopToolSource {
    specs: Vec<crate::alexander_ai_solutions::tools::ToolSpec>,
}

#[async_trait]
impl ToolSource for NoopToolSource {
    fn request_specs(&self) -> &[crate::alexander_ai_solutions::tools::ToolSpec] {
        &self.specs
    }
...
async fn run(
    ...
    run_turn_engine(
        ...
        &multimodal_files,
        8,
        crate::alexander_ai_solutions::inference::provider::AGENT_TURN_MAX_OUTPUT_TOKENS,
        None,
        &[],
        None,
        autocompact,
