...
use crate::alexander_ai_solutions::agent::dispatcher::ToolDispatcher;
use crate::alexander_ai_solutions::agent::harness::archivist::ArchivistHook;
use crate::alexander_ai_solutions::agent::harness::definition::TriggerMemoryAgent;
use crate::alexander_ai_solutions::agent::hooks::PostTurnHook;
use crate::alexander_ai_solutions::agent::memory_loader::MemoryLoader;
use crate::alexander_ai_solutions::agent::progress::AgentProgress;
use crate::alexander_ai_solutions::agent::tool_policy::ToolPolicy;
use crate::alexander_ai_solutions::agent_tool_policy::ToolPolicySession;
use crate::alexander_ai_solutions::context::prompt::SystemPromptBuilder;
use crate::alexander_ai_solutions::context::ContextManager;
use crate::alexander_ai_solutions::inference::provider::{
    ChatMessage, ConversationMessage, Provider,
};
use crate::alexander_ai_solutions::memory::Memory;
use crate::alexander_ai_solutions::tools::{Tool, ToolSpec};
...
pub struct Agent {
    ...
    pub(super) config: crate::alexander_ai_solutions::config::AgentConfig,
    ...
    pub(super) workflows: Vec<crate::alexander_ai_solutions::workflows::Workflow>,
    ...
    pub(super) last_turn_citations: Vec<crate::alexander_ai_solutions::agent::memory_loader::MemoryCitation>,
    ...
    pub(super) last_turn_usage_totals:
        Option<crate::alexander_ai_solutions::agent::harness::turn_subagent_usage::LastTurnUsage>,
    ...
    ///
    /// [`AgentDefinitionRegistry`]: crate::alexander_ai_solutions::agent::harness::definition::AgentDefinitionRegistry
    ...
    /// [`crate::alexander_ai_solutions::context`] for the full surface.
    ...
    pub(super) run_queue: Option<Arc<crate::alexander_ai_solutions::agent::harness::run_queue::RunQueue>>,
    ...
    /// integration blocks.
    pub(super) connected_integrations: Vec<crate::alexander_ai_solutions::context::prompt::ConnectedIntegration>,
    ...
    /// the Composio cache.
    pub(super) integration_runtime_config: Option<crate::alexander_ai_solutions::config::Config>,
    ...
    pub(super) payload_summarizer:
        Option<Arc<dyn crate::alexander_ai_solutions::agent::harness::payload_summarizer::PayloadSummarizer>>,
    ...
    /// model context.
    pub(super) tokenjuice_compression: crate::alexander_ai_solutions::tokenjuice::AgentTokenjuiceCompression,
    ...
    /// [`crate::alexander_ai_solutions::composio::cached_active_integrations`]; on
    ...
    /// produced by [`crate::alexander_ai_solutions::tools::orchestrator_tools::collect_orchestrator_tools`]
...
pub struct AgentBuilder {
    ...
    pub(super) config: Option<crate::alexander_ai_solutions::config::AgentConfig>,
    /// Optional [`ContextConfig`] override threaded through from
    /// `Agent::from_config`. When unset the builder falls back to
    /// [`crate::alexander_ai_solutions::config::ContextConfig::default`].
    pub(super) context_config: Option<crate::alexander_ai_solutions::config::ContextConfig>,
    ...
    pub(super) workflows: Option<Vec<crate::alexander_ai_solutions::workflows::Workflow>>,
