...
use crate::alexander_ai_solutions::agent::harness::session::types::{Agent, AgentBuilder};
use crate::alexander_ai_solutions::agent::harness::TriggerMemoryAgent;
use crate::alexander_ai_solutions::agent::memory_loader::DefaultMemoryLoader;
use crate::alexander_ai_solutions::agent_tool_policy::ToolPolicyEngine;
use crate::alexander_ai_solutions::config::ContextConfig;
use crate::alexander_ai_solutions::context::{
    ContextManager, ProviderSummarizer, SegmentRecapSummarizer,
};
...
impl AgentBuilder {
    ...
    pub fn new() -> Self {
        Self {
            ...
            tokenjuice_compression:
                crate::alexander_ai_solutions::tokenjuice::AgentTokenjuiceCompression::Full,
            tool_policy: None,
            archivist_hook: None,
    ...
    pub fn provider(
        mut self,
        provider: Box<dyn crate::alexander_ai_solutions::inference::provider::Provider>,
    ) -> Self {
    ...
    pub fn provider_arc(
        mut self,
        provider: Arc<dyn crate::alexander_ai_solutions::inference::provider::Provider>,
    ) -> Self {
    ...
    pub fn prompt_builder(
        mut self,
        prompt_builder: crate::alexander_ai_solutions::context::prompt::SystemPromptBuilder,
    ) -> Self {
    ...
    pub fn tool_dispatcher(
        mut self,
        tool_dispatcher: Box<dyn crate::alexander_ai_solutions::agent::dispatcher::ToolDispatcher>,
    ) -> Self {
    ...
    pub fn memory_loader(
        mut self,
        memory_loader: Box<dyn crate::alexander_ai_solutions::agent::memory_loader::MemoryLoader>,
    ) -> Self {
    ...
    pub fn config(mut self, config: crate::alexander_ai_solutions::config::AgentConfig) -> Self {
    ...
    pub fn workflows(
        mut self,
        skills: Vec<crate::alexander_ai_solutions::workflows::Workflow>,
    ) -> Self {
    ...
    pub fn post_turn_hooks(
        mut self,
        hooks: Vec<Arc<dyn crate::alexander_ai_solutions::agent::hooks::PostTurnHook>>,
    ) -> Self {
    ...
    /// [`crate::alexander_ai_solutions::agent::harness::payload_summarizer::PayloadSummarizer::maybe_summarize`]
    ...
    pub fn tool_policy(
        mut self,
        policy: Arc<dyn crate::alexander_ai_solutions::agent::tool_policy::ToolPolicy>,
    ) -> Self {
    ...
    pub fn archivist_hook(
        mut self,
        hook: Option<Arc<crate::alexander_ai_solutions::agent::harness::archivist::ArchivistHook>>,
    ) -> Self {
    ...
    pub fn tokenjuice_compression(
        mut self,
        profile: crate::alexander_ai_solutions::tokenjuice::AgentTokenjuiceCompression,
    ) -> Self {
    ...
    pub fn build(self) -> Result<Agent> {
        ...
        let prompt_builder = self.prompt_builder.unwrap_or_else(
            crate::alexander_ai_solutions::context::prompt::SystemPromptBuilder::with_defaults,
        );
        ...
        let inner_summarizer: Arc<dyn crate::alexander_ai_solutions::context::Summarizer> =
            Arc::new(ProviderSummarizer::new(provider.clone()));
        let session_id_for_recap = self
            .event_session_id
            .clone()
            .unwrap_or_else(|| "standalone".to_string());
        let summarizer: Arc<dyn crate::alexander_ai_solutions::context::Summarizer> =
        ...
        Ok(Agent {
            ...
            tool_policy: self.tool_policy.unwrap_or_else(|| {
                Arc::new(crate::alexander_ai_solutions::agent::tool_policy::AllowAllToolPolicy)
            }),
