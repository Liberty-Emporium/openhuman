...
fn recovery_tool_joins_a_named_allowlist() {
    use crate::alexander_ai_solutions::tokenjuice::RETRIEVE_TOOL_NAME as RECOVERY_TOOL_NAME;
...
fn automatic_memory_policy_does_not_synthesize_delegate_tools() {
    let defs = crate::alexander_ai_solutions::agent_registry::agents::load_builtins().unwrap();
    let help = defs
        .iter()
