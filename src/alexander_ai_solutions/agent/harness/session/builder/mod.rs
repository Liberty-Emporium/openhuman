...
use crate::alexander_ai_solutions::agent::harness::definition::{AgentDefinition, ToolScope};
...
pub(super) fn ensure_recovery_tool_visible(visible: &mut std::collections::HashSet<String>) {
    if !visible.is_empty() {
        for name in crate::alexander_ai_solutions::tokenjuice::RECOVERY_TOOL_NAMES {
