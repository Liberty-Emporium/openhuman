...
use crate::alexander_ai_solutions::agent::dispatcher::{ParsedToolCall, ToolExecutionResult};
use crate::alexander_ai_solutions::agent::harness::engine::ProgressReporter;
...
use crate::alexander_ai_solutions::agent::hooks::{self, ToolCallRecord};
...
use crate::alexander_ai_solutions::tools::{Tool, ToolCallOptions};
...
pub(super) async fn run_agent_tool_call(
        ...
        if session_decision.is_denied() {
            ...
            if call_required > session_decision.allowed_permission {
                ...
                if let Some(reason) = policy_decision.blocking_reason() {
                    ...
                    crate::alexander_ai_solutions::tool_registry::denials::record(
                        call.name.as_str(),
    ...
    let raw_result = crate::alexander_ai_solutions::tokenjuice::compact_output_with_policy(
        raw_result,
        &call.name,
