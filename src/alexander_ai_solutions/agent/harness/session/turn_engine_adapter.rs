...
use crate::alexander_ai_solutions::agent::harness::engine::{
...
use crate::alexander_ai_solutions::agent::harness::payload_summarizer::PayloadSummarizer;
use crate::alexander_ai_solutions::agent::harness::tool_result_artifacts::{
...
use crate::alexander_ai_solutions::context::ReductionOutcome;
...
pub(super) struct AgentToolSource {
    ...
    pub tokenjuice_compression:
        crate::alexander_ai_solutions::tokenjuice::AgentTokenjuiceCompression,
...
impl TurnObserver for AgentObserver<'_> {
    async fn before_dispatch(
        ...
        tools: &mut dyn crate::alexander_ai_solutions::agent::harness::engine::ToolSource,
        iteration: usize,
    ) -> Result<()> {
    ...
    fn record_usage(&mut self, provider: &str, model: &str, usage: &UsageInfo) {
        ...
        crate::alexander_ai_solutions::cost::record_provider_usage(model, usage);
        ...
        // the backend charge.
        let call_cost = crate::alexander_ai_solutions::agent::cost::call_cost_usd(model, usage);
