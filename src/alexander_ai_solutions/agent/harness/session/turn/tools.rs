...
use crate::alexander_ai_solutions::agent::hooks::ToolCallRecord;
...
impl Agent {
    ...
    pub(in super::super) async fn execute_tool_call(
        ...
        crate::alexander_ai_solutions::agent::dispatcher::ToolExecutionResult,
        ToolCallRecord,
    ) {
    ...
    pub(in super::super) async fn execute_tools(
        ...
        Vec<crate::alexander_ai_solutions::agent::dispatcher::ToolExecutionResult>,
        Vec<ToolCallRecord>,
    ) {
    ...
    pub(in super::super) fn build_parent_execution_context(
        ...
        let allowed_subagent_ids = crate::alexander_ai_solutions::agent::harness::definition::AgentDefinitionRegistry::global()
            ...
            .map(|definition| {
                definition
                    ...
                    .filter_map(|entry| match entry {
                        crate::alexander_ai_solutions::agent::harness::definition::SubagentEntry::AgentId(id) => {
                            Some(id.clone())
                        }
                        crate::alexander_ai_solutions::agent::harness::definition::SubagentEntry::Skills(wildcard)
                            if wildcard.matches_all() =>
                        {
                            Some("integrations_agent".to_string())
                        }
                        crate::alexander_ai_solutions::agent::harness::definition::SubagentEntry::Skills(_) => None,
                    })
                    .collect()
            })
            .unwrap_or_default();
    ...
    ///
    /// Delegates to the shared [`crate::alexander_ai_solutions::composio::fetch_connected_integrations`]
    ...
    /// [`crate::alexander_ai_solutions::composio::client::create_composio_client`]
    ...
    pub async fn fetch_connected_integrations(&mut self) {
        let config = match self.integration_runtime_config.clone() {
            Some(config) => config,
            None => match crate::alexander_ai_solutions::config::Config::load_or_init().await {
                Ok(config) => config,
                Err(e) => {
                    log::debug!(
        ...
        self.connected_integrations =
            crate::alexander_ai_solutions::composio::fetch_connected_integrations(&config).await;
    ...
    pub(in super::super) fn refresh_delegation_tools_from_cached_integrations(
        ...
        let Some(cache_view) =
            crate::alexander_ai_solutions::composio::cached_active_integrations(cfg)
        else {
            return false;
        };

        let new_hash = crate::alexander_ai_solutions::composio::connected_set_hash(&cache_view);
    ...
    pub(in super::super) fn refresh_workflows(&mut self, trigger: &str) -> bool {
        let id_of = |w: &crate::alexander_ai_solutions::workflows::Workflow| -> String {
        ...
        let latest =
            crate::alexander_ai_solutions::workflows::load_workflow_metadata(&self.workspace_dir);
    ...
    pub fn refresh_delegation_tools(&mut self) -> bool {
        use crate::alexander_ai_solutions::agent::harness::definition::AgentDefinitionRegistry;
        use crate::alexander_ai_solutions::tools::orchestrator_tools::collect_orchestrator_tools;
        ...
        let synthed_specs: Vec<crate::alexander_ai_solutions::tools::ToolSpec> =
