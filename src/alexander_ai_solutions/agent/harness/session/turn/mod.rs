...
/// Wrapper around
/// [`crate::alexander_ai_solutions::memory_tree::tree_runtime::store::collect_root_summaries_with_caps`]
...
/// preset by [`crate::alexander_ai_solutions::config::schema::agent::AgentConfig::resolved_memory_limits`].
pub(super) fn collect_tree_root_summaries(
    workspace_dir: &std::path::Path,
    per_namespace_cap: usize,
    total_cap: usize,
) -> Vec<crate::alexander_ai_solutions::context::prompt::NamespaceSummary> {
    crate::alexander_ai_solutions::memory_tree::tree_runtime::store::collect_root_summaries_with_caps(
        workspace_dir,
        per_namespace_cap,
        total_cap,
    ...
    .into_iter()
    .map(
        |(namespace, body, updated_at)| crate::alexander_ai_solutions::context::prompt::NamespaceSummary {
            namespace,
            body,
            updated_at,
        },
...
#[cfg(test)]
pub(crate) use crate::alexander_ai_solutions::context::prompt::LearnedContextData;
#[cfg(test)]
