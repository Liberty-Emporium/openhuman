...
use crate::alexander_ai_solutions::agent_tool_policy::render_tool_policy_boundary;
...
impl Agent {
    ...
    pub(in super::super) async fn fetch_learned_context(&self) -> LearnedContextData {
        ...
        if !self.learning_enabled && self.explicit_preferences_enabled {
            let general =
                crate::alexander_ai_solutions::memory::preferences::load_general_preferences(
                    &self.memory,
                    crate::alexander_ai_solutions::memory::preferences::STANDING_PREFS_LIMIT,
                )
                .await;
            tracing::debug!(
        ...
        let general = crate::alexander_ai_solutions::memory::preferences::load_general_preferences(
            &self.memory,
            crate::alexander_ai_solutions::memory::preferences::STANDING_PREFS_LIMIT,
        )
        .await;
        ...
        let reflection_entries = self
            .memory
            .list(
                Some(crate::alexander_ai_solutions::learning::reflection::REFLECTIONS_NAMESPACE),
                Some(&MemoryCategory::Custom(
                    crate::alexander_ai_solutions::learning::reflection::REFLECTIONS_NAMESPACE
                        .into(),
                )),
                None,
            )
    ...
    pub fn build_system_prompt(&self, learned: LearnedContextData) -> Result<String> {
        ...
        let ctx = PromptContext {
            ...
            user_identity:
                crate::alexander_ai_solutions::app_state::peek_cached_current_user_identity(),
