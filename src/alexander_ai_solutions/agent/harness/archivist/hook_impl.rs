...
impl PostTurnHook for ArchivistHook {
    ...
    async fn on_turn_complete(&self, ctx: &TurnContext) -> anyhow::Result<()> {
        ...
        if let Some(cfg) = self.config.as_ref() {
            ...
            let user_turn = crate::alexander_ai_solutions::memory_archivist::ArchivedTurn {
                session_id: session_id.to_string(),
            ...
            match crate::alexander_ai_solutions::memory_archivist::store::record_turn(
                cfg, user_turn,
            ) {
            ...
            let assistant_turn = crate::alexander_ai_solutions::memory_archivist::ArchivedTurn {
                session_id: session_id.to_string(),
                seq: 0,
            ...
            if let Err(e) = crate::alexander_ai_solutions::memory_archivist::store::record_turn(
                cfg,
                assistant_turn,
            ) {
