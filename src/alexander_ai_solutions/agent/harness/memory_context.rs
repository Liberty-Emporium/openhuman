...
pub(crate) async fn build_context(
        ...
        .await
    {
        ...
        if !cross.is_empty() {
            ...
            context
                .push_str(crate::alexander_ai_solutions::agent::memory_loader::CROSS_CHAT_HEADER);
            for entry in &cross {
                let prov = entry
                    .session_id
                    .as_deref()
...
mod tests {
    ...
    async fn build_context_surfaces_cross_chat_block_with_provenance() {
        ...
        assert!(
            context.contains(
                crate::alexander_ai_solutions::agent::memory_loader::CROSS_CHAT_HEADER.trim_end()
            ),
