...
//! [`crate::alexander_ai_solutions::config::ContextConfig::tool_result_budget_bytes`],
...
//! ([`crate::alexander_ai_solutions::agent::harness::session::builder::AgentBuilder`]
...
/// [`crate::alexander_ai_solutions::agent::harness::session::Agent::execute_tool_call`]
...
pub struct SubagentPayloadSummarizer {
    ...
    /// [`crate::alexander_ai_solutions::config::ContextConfig`] (500 000 tokens).
    ...
    /// [`crate::alexander_ai_solutions::config::ContextConfig`] (2 000 000 tokens).
...
/// [`crate::alexander_ai_solutions::memory_tree::tree_runtime::types::estimate_tokens`] but
