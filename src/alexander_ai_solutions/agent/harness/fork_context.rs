...
//! the [`crate::alexander_ai_solutions::tools::Tool`] trait.
//!
//! [`PARENT_CONTEXT`] is set by the parent
//! [`crate::alexander_ai_solutions::agent::Agent`] around its `turn` so that any tool
...
use crate::alexander_ai_solutions::config::AgentConfig;
...
use crate::alexander_ai_solutions::workflows::Workflow;
...
/// running inside [`crate::alexander_ai_solutions::agent::Agent::turn`] via the
...
pub struct ParentExecutionContext {
    ...
    pub connected_integrations:
        Vec<crate::alexander_ai_solutions::context::prompt::ConnectedIntegration>,
    ...
    pub tool_call_format: crate::alexander_ai_solutions::context::prompt::ToolCallFormat,
    ...
    pub run_queue: Option<Arc<crate::alexander_ai_solutions::agent::harness::run_queue::RunQueue>>,
}
...
///
/// Returns `None` when called from outside [`crate::alexander_ai_solutions::agent::Agent::turn`]
