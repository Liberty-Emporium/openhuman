...
/// [`crate::alexander_ai_solutions::agent::multimodal`]: the harness embeds image
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::inference::provider::ToolCall;
    ...
    fn conversation_tool_results_are_counted_in_estimate() {
        let msg = ConversationMessage::ToolResults(vec![
            crate::alexander_ai_solutions::inference::provider::ToolResultMessage {
    ...
    fn tool_results(ids: &[&str]) -> ConversationMessage {
        ConversationMessage::ToolResults(
            ids.iter()
                .map(
                    |id| crate::alexander_ai_solutions::inference::provider::ToolResultMessage {
