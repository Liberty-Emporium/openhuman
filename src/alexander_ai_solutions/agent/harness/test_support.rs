...
//!    [`crate::alexander_ai_solutions::composio::ComposioClient`] to exercise the
...
use crate::alexander_ai_solutions::composio::ComposioClient;
...
impl FakeComposioBackend {
    ...
    /// ([`crate::alexander_ai_solutions::composio::ComposioActionTool`],
    ...
    /// resolves. Callers must hold `crate::alexander_ai_solutions::config::TEST_ENV_LOCK`
    ...
    pub async fn config_persisted(
        ...
        std::sync::Arc<crate::alexander_ai_solutions::config::Config>,
        std::path::PathBuf,
    ) {
        ...
        config.composio.mode =
            crate::alexander_ai_solutions::config::schema::COMPOSIO_MODE_BACKEND.to_string();
