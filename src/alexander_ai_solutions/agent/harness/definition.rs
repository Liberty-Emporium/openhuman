...
//! [`crate::alexander_ai_solutions::agent_registry::agents`] — one subfolder per agent, each
...
//! to `~/.alexanderai/agents/*.toml` for user-global specialists) which
...
pub struct AgentDefinition {
    ...
    /// [`crate::alexander_ai_solutions::context::prompt::render_subagent_system_prompt`].
    #[serde(default = "defaults::true_")]
    ...
    ///
    /// [`ArchetypeDelegationTool`]: crate::alexander_ai_solutions::agent_orchestration::tools::ArchetypeDelegationTool
    /// [`SkillDelegationTool`]: crate::alexander_ai_solutions::agent_orchestration::tools::SkillDelegationTool
...
/// pairs at boot (see
/// [`crate::alexander_ai_solutions::agent_registry::agents::validate_tier_hierarchy`]). The
...
/// full runtime [`crate::alexander_ai_solutions::context::prompt::PromptContext`]
...
/// [`crate::alexander_ai_solutions::context::prompt`] in the order the builder
/// wants.
pub type PromptBuilder = fn(
    &crate::alexander_ai_solutions::context::prompt::PromptContext<'_>,
...
pub enum DefinitionSource {
    ...
    /// [`crate::alexander_ai_solutions::agent_registry::agents`]).
    #[default]
    Builtin,
...
impl AgentDefinitionRegistry {
    ...
    /// `~/.alexanderai/agents/*.toml` fallback). Custom definitions
    ...
    pub fn load(workspace: &Path) -> Result<Self> {
        ...
        // [`crate::alexander_ai_solutions::agent_registry::agents::loader::validate_tier_hierarchy`].
        let snapshot: Vec<AgentDefinition> = reg.list().into_iter().cloned().collect();
        crate::alexander_ai_solutions::agent_registry::agents::validate_tier_hierarchy(&snapshot)
            .map_err(|e| {
            anyhow::anyhow!(
    ...
    /// [`crate::alexander_ai_solutions::config::Config::load_or_init`] and load from
    ...
    pub async fn load_for_default_workspace() -> Result<Self> {
        let config = crate::alexander_ai_solutions::config::Config::load_or_init().await?;
