...
pub(crate) fn resolve_subagent_provider(
    spec: &crate::alexander_ai_solutions::agent::harness::definition::ModelSpec,
    agent_id: &str,
    config: Option<&crate::alexander_ai_solutions::config::Config>,
...
pub(crate) fn user_is_signed_in_to_composio(
    ...
    crate::alexander_ai_solutions::composio::client::create_composio_client(config).is_ok()
}
...
/// [`crate::alexander_ai_solutions::composio::ComposioClient`] so the live
/// `composio.mode` toggle is honoured per execute — see
/// [`crate::alexander_ai_solutions::composio::ComposioActionTool`] and issue #1710.
pub(crate) struct LazyToolkitResolver {
    pub(crate) config: std::sync::Arc<crate::alexander_ai_solutions::config::Config>,
    pub(crate) actions:
        Vec<crate::alexander_ai_solutions::context::prompt::ConnectedIntegrationTool>,
}
...
impl LazyToolkitResolver {
    pub(super) fn resolve(
        &self,
        name: &str,
    ) -> Option<Box<dyn crate::alexander_ai_solutions::tools::Tool>> {
    ...
    fn find_action(
        &self,
        name: &str,
    ) -> Option<&crate::alexander_ai_solutions::context::prompt::ConnectedIntegrationTool> {
