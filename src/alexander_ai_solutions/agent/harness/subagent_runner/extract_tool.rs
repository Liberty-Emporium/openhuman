...
use crate::alexander_ai_solutions::agent::harness::session::transcript::{
...
use crate::alexander_ai_solutions::tools::{Tool, ToolCategory, ToolResult};
...
impl ExtractFromResultTool {
    ...
    async fn extract_chunk_char_budget(&self) -> usize {
        let window = self
            ...
            .await
            .or_else(|| {
                crate::alexander_ai_solutions::inference::context_window_for_model(&self.model)
            });
...
mod tests {
    ...
    fn chunk_budget_tracks_context_window() {
        let summarization_window =
            crate::alexander_ai_solutions::inference::context_window_for_model("summarization-v1");
