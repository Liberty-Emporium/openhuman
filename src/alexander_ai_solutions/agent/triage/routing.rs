...
use crate::alexander_ai_solutions::inference::provider::{self, Provider, INFERENCE_BACKEND_ID};

/// The concrete provider + metadata that [`crate::alexander_ai_solutions::agent::triage::evaluator::run_triage`]
...
pub fn build_local_provider_with_config(config: &Config) -> Option<ResolvedProvider> {
    ...
    let (label, base) = if use_openai_compat {
        ...
        let ollama_base = crate::alexander_ai_solutions::inference::local::ollama_base_url();
...
fn is_local_cli_route(provider_string: &str) -> bool {
    use crate::alexander_ai_solutions::inference::provider::claude_code;
    use crate::alexander_ai_solutions::inference::provider::factory::{
