...
//! `run_turn` invocation. Read by [`crate::alexander_ai_solutions::approval::ApprovalGate`]
//! and [`crate::alexander_ai_solutions::agent_tool_policy::ToolPolicyEngine`] to make
...
//!
//! Every entry point that drives the agent loop ([`crate::alexander_ai_solutions::channels::providers::web`],
//! [`crate::alexander_ai_solutions::channels::runtime::dispatch`], [`crate::alexander_ai_solutions::subconscious`],
//! [`crate::alexander_ai_solutions::cron`], CLI) MUST scope a real [`AgentTurnOrigin`]
...
/// entry point that owns the turn and read by [`crate::alexander_ai_solutions::approval`]
/// alongside the existing per-turn chat context.
#[derive(Clone, Debug)]
pub enum AgentTurnOrigin {
    /// Live user chat in the desktop / web UI. The existing
    /// [`crate::alexander_ai_solutions::approval::ApprovalChatContext`] task-local is
...
/// [`crate::alexander_ai_solutions::approval::APPROVAL_CHAT_CONTEXT`] scope pattern.
///
