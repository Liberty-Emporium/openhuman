...
//! - **[`crate::alexander_ai_solutions::agent_registry::agents`]**: Definitions for built-in
...
/// `alexander_ai_solutions::context::prompt` so prompt rendering lives next to the
/// agents that consume it. `alexander_ai_solutions::context::prompt` is retained as
