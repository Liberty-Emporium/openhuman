...
pub enum AgentProgress {
    ...
    ToolCallStarted {
        ...
        /// formatter. Set from [`crate::alexander_ai_solutions::tools::traits::Tool::display_label`].
    ...
    /// from inside [`crate::alexander_ai_solutions::agent::harness::subagent_runner`]**
    ...
    SubagentIterationStarted {
        ...
        max_iterations: u32,
        /// `true` when the agent uses [`IterationPolicy::Extended`](crate::alexander_ai_solutions::agent::harness::definition::IterationPolicy::Extended).
    ...
    /// inside [`crate::alexander_ai_solutions::agent::harness::subagent_runner`]** when
    ...
    TaskBoardUpdated {
        board: crate::alexander_ai_solutions::agent::task_board::TaskBoard,
    },
    ...
    /// [`crate::alexander_ai_solutions::agent::cost::TurnCost::total_usd`].
    TurnCostUpdated {
