...
pub struct ReflectionMemoryContextSection {
    chunks: Vec<crate::alexander_ai_solutions::subconscious::SourceChunk>,
}

impl ReflectionMemoryContextSection {
    pub fn new(chunks: Vec<crate::alexander_ai_solutions::subconscious::SourceChunk>) -> Self {
        Self { chunks }
    }
}
...
impl PromptSection for ReflectionMemoryContextSection {
    ...
    fn build(&self, _ctx: &PromptContext<'_>) -> Result<String> {
        ...
        // it'll quote.
        let usable: Vec<&crate::alexander_ai_solutions::subconscious::SourceChunk> = self
            .chunks
            .iter()
...
/// [`crate::alexander_ai_solutions::agent::harness::definition::AgentDefinition`]'s
...
/// Section that defers to a [`crate::alexander_ai_solutions::agent::harness::definition::PromptBuilder`]
...
pub struct DynamicPromptSection {
    builder: crate::alexander_ai_solutions::agent::harness::definition::PromptBuilder,
}
...
impl PromptSection for WorkspaceSection {
    ...
    fn build(&self, _ctx: &PromptContext<'_>) -> Result<String> {
        ...
        let scratch = crate::alexander_ai_solutions::security::openhuman_scratch_dir();
