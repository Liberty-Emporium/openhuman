...
pub fn render_subagent_system_prompt(
    ...
    parent_tools: &[Box<dyn crate::alexander_ai_solutions::tools::Tool>],
    extra_tools: &[Box<dyn crate::alexander_ai_solutions::tools::Tool>],
    archetype_body: &str,
...
pub fn render_subagent_system_prompt_with_format(
    ...
    if !matches!(tool_call_format, ToolCallFormat::Native) {
        out.push_str("## Tools\n\n");
        let render_one =
            |out: &mut String, tool: &dyn crate::alexander_ai_solutions::tools::Tool| {
...
fn empty_prompt_context_for_static_sections() -> PromptContext<'static> {
    ...
    static EMPTY_WORKFLOWS: &[crate::alexander_ai_solutions::workflows::Workflow] = &[];
...
fn render_pformat_signature_for_box_tool(
    tool: &dyn crate::alexander_ai_solutions::tools::Tool,
) -> String {
