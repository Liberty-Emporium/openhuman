...
pub fn render_connected_identities() -> String {
    let identities =
        crate::alexander_ai_solutions::composio::providers::profile::load_connected_identities();
    crate::alexander_ai_solutions::composio::providers::profile::render_connected_identities_section(
        &identities,
    )
}
