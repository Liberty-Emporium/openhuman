...
pub async fn bootstrap_after_login() -> Result<(), String> {
    ...
    let heartbeat = crate::alexander_ai_solutions::heartbeat::engine::HeartbeatEngine::new(
...
fn bootstrap_trigger_orchestrator(config: &crate::alexander_ai_solutions::config::Config) {
    use crate::alexander_ai_solutions::subconscious_triggers::{
...
pub async fn stop_heartbeat_loop() {
    ...
    crate::alexander_ai_solutions::subconscious_triggers::shutdown_orchestrator();
    crate::alexander_ai_solutions::subconscious_triggers::unregister_subconscious_triggers_subscriber();
