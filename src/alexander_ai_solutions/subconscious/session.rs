...
use crate::alexander_ai_solutions::memory_conversations::ConversationMessage;
...
impl LongLivedSession {
    ...
    pub async fn process_promoted(
        ...
        let response = {
            ...
            let origin = crate::alexander_ai_solutions::agent::turn_origin::AgentTurnOrigin::TrustedAutomation {
    ...
    fn persist_message(&self, sender: &str, content: &str, tainted: bool) {
        ...
        if let Err(err) = crate::alexander_ai_solutions::memory_conversations::append_message(
            self.workspace_dir.clone(),
            &self.thread_id,
            message,
        ) {
...
pub(crate) fn ensure_reserved_thread(
    ...
    if let Err(err) = crate::alexander_ai_solutions::memory_conversations::ensure_thread(
