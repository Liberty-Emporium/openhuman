...
use crate::alexander_ai_solutions::notifications::types::CoreNotificationEvent;
        ...
        if event.category == types::HeartbeatCategory::Meetings && plan.allow_external {
            if let Some(meeting_url) = event.meeting_url.clone() {
                ...
                let owns_notification =
                    crate::alexander_ai_solutions::agent_meetings::calendar::handle_calendar_meeting_candidate(
                        meeting_url,
                        event.title.clone(),
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::config::Config;
    use crate::alexander_ai_solutions::cron::{self, Schedule};
    use crate::alexander_ai_solutions::notifications::subscribe_core_notifications;
    use chrono::TimeZone;
    use serde_json::json;
