...
/// Mirrors [`crate::alexander_ai_solutions::subconscious_triggers::SUBCONSCIOUS_SENDER_MARKER`]
...
impl Tool for NotifyUserTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let config = crate::alexander_ai_solutions::config::load_config_with_timeout()
            .await
...
mod tests {
    ...
    fn proactive_source_matches_trigger_marker() {
        assert_eq!(
            ...
            crate::alexander_ai_solutions::subconscious_triggers::SUBCONSCIOUS_SENDER_MARKER
        );
    }
}
