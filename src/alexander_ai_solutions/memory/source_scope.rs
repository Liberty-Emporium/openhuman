...
//!
//! [`thread_context`]: crate::alexander_ai_solutions::inference::provider::thread_context
//!
//! ```ignore
//! use crate::alexander_ai_solutions::memory::source_scope::{with_source_scope, current_source_scope};
//!
...
pub fn chunk_source_allowed_in(set: &HashSet<String>, tags: &[String], source_id: &str) -> bool {
    ...
    crate::alexander_ai_solutions::memory::sync::extract_mem_src_id(source_id)
