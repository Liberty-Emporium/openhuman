...
//! [`crate::alexander_ai_solutions::memory_tree::tree::registry::get_or_create_tree`]
...
use crate::alexander_ai_solutions::memory_store::trees::types::Tree;
...
pub fn get_or_create_source_tree(config: &Config, scope: &str) -> Result<Tree> {
    log::debug!(
        ...
        crate::alexander_ai_solutions::memory::util::redact::redact(scope)
    );
