...
pub(crate) fn parse_source_kind_str(
    s: &str,
) -> Option<crate::alexander_ai_solutions::memory_store::chunks::types::SourceKind> {
    crate::alexander_ai_solutions::memory_store::chunks::types::SourceKind::parse(s).ok()
}

#[cfg(test)]
pub(crate) use crate::alexander_ai_solutions::config::Config;
#[cfg(test)]
pub(crate) use crate::alexander_ai_solutions::memory_store::chunks::store::with_connection;
#[cfg(test)]
pub(crate) use crate::alexander_ai_solutions::memory_store::chunks::types::SourceKind;
#[cfg(test)]
