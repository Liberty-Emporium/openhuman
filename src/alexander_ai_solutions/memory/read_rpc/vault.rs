...
use crate::alexander_ai_solutions::memory_store::content::obsidian_registry;
...
pub async fn obsidian_vault_status_rpc(
    ...
    let log = format!(
        ...
        resp.registered,
        resp.config_found,
        crate::alexander_ai_solutions::memory::util::redact::redact(&resp.content_root_abs),
    );
...
pub async fn vault_health_check_rpc(
    ...
    let pipeline =
        crate::alexander_ai_solutions::memory_tree::tree::rpc::pipeline_status_rpc(config)
            .await
