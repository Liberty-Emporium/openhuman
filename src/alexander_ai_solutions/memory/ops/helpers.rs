...
use crate::alexander_ai_solutions::memory_store::GraphRelationRecord;
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::memory_store::RetrievalScoreBreakdown;
...
/// It does **not** fall back to `~/.alexanderai/workspace`; that hazard is the
/// one [`crate::alexander_ai_solutions::memory::global::client`] guards against, and it
