...
//! [`crate::alexander_ai_solutions::memory_tools`]).
//!
...
mod tests {
    ...
    use super::*;
    use crate::alexander_ai_solutions::memory_tools::ToolMemoryPriority;
    ...
    async fn tool_rule_put_get_list_and_delete_roundtrip() {
        ...
        assert_eq!(
            stored.source,
            crate::alexander_ai_solutions::memory_tools::ToolMemorySource::Programmatic
        );
