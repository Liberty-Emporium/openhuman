...
use crate::alexander_ai_solutions::memory_sync::composio::{self, SyncReason};
...
/// [`crate::alexander_ai_solutions::memory::IngestionStatusSnapshot`] but is the public RPC
...
pub async fn memory_ingestion_status() -> Result<RpcOutcome<IngestionStatusResult>, String> {
    let snapshot = match crate::alexander_ai_solutions::memory::global::client_if_ready() {
...
mod tests {
    ...
    fn ensure_memory_client() -> crate::alexander_ai_solutions::memory_store::MemoryClientRef {
        crate::alexander_ai_solutions::memory::ops::ensure_shared_memory_client();
        crate::alexander_ai_solutions::memory::global::client().expect("memory client")
    }
