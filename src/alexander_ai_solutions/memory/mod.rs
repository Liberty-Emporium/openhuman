...
//! layer down in [`memory_store`](crate::alexander_ai_solutions::memory_store).
...
pub use crate::alexander_ai_solutions::memory_queue as jobs;
pub use crate::alexander_ai_solutions::memory_store::types::NamespaceDocumentInput;
pub use crate::alexander_ai_solutions::memory_store::{MemoryClient, UnifiedMemory};
