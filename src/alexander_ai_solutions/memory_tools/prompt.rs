...
//! [`crate::alexander_ai_solutions::agent::prompts::SystemPromptBuilder::build`]).
//!
...
//! the pattern used by
//! [`crate::alexander_ai_solutions::agent::prompts::ReflectionMemoryContextSection`].
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::agent::prompts::types::{
        LearnedContextData, PromptContext, ToolCallFormat,
    };
    use crate::alexander_ai_solutions::memory_tools::types::ToolMemorySource;
