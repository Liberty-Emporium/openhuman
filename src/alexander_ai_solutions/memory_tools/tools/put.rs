...
use crate::alexander_ai_solutions::memory::ops::helpers::active_memory_client;
use crate::alexander_ai_solutions::memory_tools::{
...
mod tests {
    ...
    use crate::alexander_ai_solutions::memory_tools::ToolMemoryStore;
    ...
    async fn execute_success_path_persists_rule_in_isolated_workspace() {
        ...
        let client = crate::alexander_ai_solutions::memory::ops::helpers::active_memory_client()
            .await
