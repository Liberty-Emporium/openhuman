...
//! `tool_effectiveness`.
//!
//! [`ToolTrackerHook`]: crate::alexander_ai_solutions::learning::ToolTrackerHook
...
use crate::alexander_ai_solutions::agent::hooks::{PostTurnHook, ToolCallRecord, TurnContext};
...
mod tests {
    ...
    use crate::alexander_ai_solutions::memory_tools::store::ToolMemoryStore;
    use crate::alexander_ai_solutions::memory_tools::test_helpers::MockMemory;
    ...
    async fn safety_case_never_email_sarah_pins_into_prompt_block() {
        ...
        let rendered = crate::alexander_ai_solutions::memory_tools::render_tool_memory_rules(&flat);
