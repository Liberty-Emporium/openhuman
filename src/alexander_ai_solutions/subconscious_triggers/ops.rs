...
use crate::alexander_ai_solutions::subconscious::{ORCHESTRATOR_THREAD_ID, USER_THREAD_ID};
...
pub async fn build_status() -> Result<TriggerStatus, String> {
    let config = crate::alexander_ai_solutions::config::load_config_with_timeout().await?;
