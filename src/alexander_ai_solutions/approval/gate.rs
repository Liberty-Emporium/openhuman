...
//! [`crate::alexander_ai_solutions::tools::Tool::external_effect`] returns `true`.
//!
//! Flow (issue #1339):
...
//!    [`crate::alexander_ai_solutions::security::live_policy`]). Hit → `Allow`
...
use crate::alexander_ai_solutions::agent::turn_origin::{
    self, AgentTurnOrigin, TrustedAutomationSource,
};
...
impl ApprovalGate {
    ...
    fn tool_is_auto_approved(&self, tool_name: &str) -> bool {
        if let Some(policy) = crate::alexander_ai_solutions::security::live_policy::current() {
