...
impl FieldBounds {
    pub fn from_element(b: &crate::alexander_ai_solutions::accessibility::ElementBounds) -> Self {
        Self {
            x: b.x,
            y: b.y,
            width: b.width,
    ...
    pub fn to_element(&self) -> crate::alexander_ai_solutions::accessibility::ElementBounds {
        crate::alexander_ai_solutions::accessibility::ElementBounds {
            x: self.x,
            y: self.y,
            width: self.width,
            height: self.height,
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::accessibility::ElementBounds;
    use serde_json::json;
