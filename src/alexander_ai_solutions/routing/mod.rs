...
//! ```rust,ignore
//! use std::sync::Arc;
//! use crate::alexander_ai_solutions::routing;
//! use crate::alexander_ai_solutions::inference::provider::create_backend_inference_provider;
//! use crate::alexander_ai_solutions::inference::provider::compatible::{AuthStyle, OpenAiCompatibleProvider};
//!
