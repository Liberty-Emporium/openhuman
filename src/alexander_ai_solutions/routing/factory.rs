...
use crate::alexander_ai_solutions::config::LocalAiConfig;
use crate::alexander_ai_solutions::inference::local::lm_studio::lm_studio_base_url_from_local_ai;
use crate::alexander_ai_solutions::inference::local::ollama_base_url;
use crate::alexander_ai_solutions::inference::local::provider::normalize_provider;
...
mod tests {
    ...
    use crate::alexander_ai_solutions::inference::provider::traits::{
        ProviderCapabilities, ToolsPayload,
    };
    use crate::alexander_ai_solutions::tools::ToolSpec;
    ...
    fn factory_env_override_url_takes_precedence_over_base_url() {
        ...
        let _guard = crate::alexander_ai_solutions::inference::local::inference_test_guard();
        unsafe {
