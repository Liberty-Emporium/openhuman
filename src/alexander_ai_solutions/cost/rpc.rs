...
//! by [`crate::alexander_ai_solutions::cost::init_global`]. When the global is missing —
...
use crate::alexander_ai_solutions::config::{Config, CostConfig};
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::cost::types::TokenUsage;
    use chrono::Utc;
    use std::collections::HashMap;
