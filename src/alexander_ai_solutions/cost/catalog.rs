...
//!
//! - pre-fill [`crate::alexander_ai_solutions::config::schema::ModelRegistryEntry`] rows so
//!   the Model Health dashboard shows real numbers instead of zeros, and
//! - power the fallback estimate in
//!   [`crate::alexander_ai_solutions::agent::cost::lookup_pricing`] when a backend doesn't
