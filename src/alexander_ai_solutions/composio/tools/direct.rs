...
impl ComposioTool {
    ...
    fn client(&self) -> Client {
        crate::alexander_ai_solutions::config::build_runtime_proxy_client_with_timeouts(
            "tool.composio",
            60,
            10,
        )
    ...
    /// in [`crate::alexander_ai_solutions::composio::client::ComposioClient::list_tools`];
...
fn sanitize_error_message(message: &str) -> String {
    ...
    crate::alexander_ai_solutions::util::truncate_with_ellipsis(&sanitized, 240)
}
