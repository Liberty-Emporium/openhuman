...
//! [`crate::alexander_ai_solutions::integrations::IntegrationClient`] so they inherit
...
use crate::alexander_ai_solutions::integrations::IntegrationClient;
...
impl ComposioClient {
    ...
    async fn raw_delete<T: serde::de::DeserializeOwned>(&self, path: &str) -> Result<T> {
        ...
        let http_client = crate::alexander_ai_solutions::tls::tls_client_builder()
            .http1_only()
        ...
        if !status.is_success() {
            ...
            let detail = crate::alexander_ai_solutions::integrations::client::extract_error_detail(
                &body_text,
                crate::alexander_ai_solutions::integrations::client::MAX_ERROR_BODY_LEN,
            );
            ...
            let logged_body =
                crate::alexander_ai_solutions::integrations::client::extract_error_detail(
                    &body_text, 300,
                );
            tracing::debug!(
...
/// [`crate::alexander_ai_solutions::agent::harness::subagent_runner::user_is_signed_in_to_composio`]
/// (probe) instead.
///
...
/// [`crate::alexander_ai_solutions::integrations::build_client`]. The only reason
...
pub(super) fn build_composio_client(
    ...
    let inner = crate::alexander_ai_solutions::integrations::build_client(config)?;
...
use crate::alexander_ai_solutions::config::schema::{COMPOSIO_MODE_BACKEND, COMPOSIO_MODE_DIRECT};
...
pub enum ComposioClientKind {
    ...
    Direct(Arc<crate::alexander_ai_solutions::tools::ComposioTool>),
}
...
///   [`crate::alexander_ai_solutions::credentials::COMPOSIO_DIRECT_PROVIDER`]
...
pub fn create_composio_client(
    ...
    match mode {
        ...
        MODE_DIRECT_PAT => {
            ...
            let stored =
                crate::alexander_ai_solutions::credentials::get_composio_api_key(config)
            ...
            // context.
            let security =
                Arc::new(crate::alexander_ai_solutions::security::SecurityPolicy::default());
            ...
            let tool = match (
                ...
                (Some(base_v2), Some(base_v3)) => {
                    crate::alexander_ai_solutions::tools::ComposioTool::new_with_base_urls_for_loopback(
                        &api_key,
                ...
                _ => crate::alexander_ai_solutions::tools::ComposioTool::new(
                    &api_key,
                    Some(config.composio.entity_id.as_str()),
                    security,
                ),
            ...
            let tool = crate::alexander_ai_solutions::tools::ComposioTool::new(
                &api_key,
                Some(config.composio.entity_id.as_str()),
                security,
            );
...
/// [`crate::alexander_ai_solutions::tools::ComposioTool::get_connection_url`] and
...
/// [`crate::alexander_ai_solutions::tools::ComposioTool::list_connected_accounts`])
...
/// [`crate::alexander_ai_solutions::tools::ComposioTool::list_tool_schemas_v3`] and
