...
//! [`crate::alexander_ai_solutions::config::ComposioConfig::mode`] toggle — see
...
pub struct ComposioActionTool {
    ...
    /// the [`crate::alexander_ai_solutions::config::ComposioConfig::mode`] toggle is
...
mod tests {
    ...
    fn factory_routes_through_backend_when_mode_is_backend() {
        ...
        let msg = match crate::alexander_ai_solutions::composio::client::create_composio_client(
            &config,
        ) {
    ...
    fn factory_routes_through_direct_when_mode_is_direct() {
        ...
        assert!(
            matches!(
                kind,
                crate::alexander_ai_solutions::composio::client::ComposioClientKind::Direct(_)
            ),
