...
use crate::alexander_ai_solutions::config::{Config, SchedulerGateMode};
...
pub fn run_doctor(config: &Config) -> DoctorReport {
    use crate::alexander_ai_solutions::memory_queue::store as queue;
    use crate::alexander_ai_solutions::memory_queue::types::JobStatus;
    use crate::alexander_ai_solutions::memory_store::chunks::store as chunks;
    ...
    let (summary_ok, summary_note) =
        crate::alexander_ai_solutions::memory_tree::tree_runtime::ops::summarizer_available(config);
...
mod tests {
    ...
    fn local_ai_off_reports_no_provider_without_cloud_opt_in() {
        ...
        assert_eq!(
            tree.ok,
            crate::alexander_ai_solutions::memory_tree::tree_runtime::ops::summarizer_available(
                &cfg
            )
            .0,
