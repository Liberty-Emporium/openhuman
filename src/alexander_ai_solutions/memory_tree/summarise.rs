...
use crate::alexander_ai_solutions::memory::chat::{build_chat_provider, ChatPrompt};
...
mod tests {
    ...
    struct UsageReportingProvider {
        response: String,
        usage: Option<crate::alexander_ai_solutions::inference::provider::UsageInfo>,
    }

    #[async_trait::async_trait]
    impl crate::alexander_ai_solutions::memory::chat::ChatProvider for UsageReportingProvider {
        fn name(&self) -> &str {
        ...
        async fn chat_for_text_with_usage(
            ...
            String,
            Option<crate::alexander_ai_solutions::inference::provider::UsageInfo>,
        )> {
    ...
    async fn summarise_threads_provider_usage_into_output() {
        ...
        use crate::alexander_ai_solutions::memory::chat::test_override;
