...
use crate::alexander_ai_solutions::memory::ingest_pipeline::ingest_chat;
use crate::alexander_ai_solutions::memory_store::chunks::types::SourceKind;
use crate::alexander_ai_solutions::memory_sync::canonicalize::chat::{ChatBatch, ChatMessage};
use crate::alexander_ai_solutions::memory_tree::retrieval::{
...
async fn ingest_populates_chunk_embeddings() {
    use crate::alexander_ai_solutions::memory_queue::drain_until_idle;
    use crate::alexander_ai_solutions::memory_store::chunks::store::get_chunk_embedding;
    use crate::alexander_ai_solutions::memory_tree::score::embed::EMBEDDING_DIM;
