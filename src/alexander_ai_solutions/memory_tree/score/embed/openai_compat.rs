...
impl OpenAiCompatEmbedder {
    ...
    pub fn try_from_config(config: &Config) -> Result<Option<Self>> {
        ...
        let api_key = crate::alexander_ai_solutions::embeddings::resolve_api_key(config, cred_slug);
        ...
        if !crate::alexander_ai_solutions::embeddings::model_supports_dimensions(model)
        ...
        let inner =
            crate::alexander_ai_solutions::embeddings::create_embedding_provider_with_credentials(
                slug,
                model,
                EMBEDDING_DIM,
                &api_key,
...
mod tests {
    ...
    fn lmstudio_entry(
        endpoint: &str,
    ) -> crate::alexander_ai_solutions::config::schema::cloud_providers::CloudProviderCreds {
        crate::alexander_ai_solutions::config::schema::cloud_providers::CloudProviderCreds {
    ...
    fn reserved_slugs_still_fall_through() {
        use crate::alexander_ai_solutions::config::schema::cloud_providers::CloudProviderCreds;
