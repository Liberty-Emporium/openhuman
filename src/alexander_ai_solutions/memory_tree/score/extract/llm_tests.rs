...
async fn extract_clears_structure_latch_on_completed_empty_extraction() {
    ...
    assert!(
        crate::alexander_ai_solutions::memory_tree::health::current_degraded_state().structure,
...
async fn extract_does_not_retry_on_permanent_402() {
    ...
    let state = crate::alexander_ai_solutions::memory_tree::health::current_degraded_state();
    assert!(
        state.structure,
    ...
    assert_eq!(
        ...
        crate::alexander_ai_solutions::memory_tree::health::FailureCode::BudgetExhausted,
