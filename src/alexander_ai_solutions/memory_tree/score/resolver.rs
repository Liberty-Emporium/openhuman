...
use crate::alexander_ai_solutions::memory_tree::score::extract::{EntityKind, ExtractedEntities};
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::memory_tree::score::extract::ExtractedEntity;
    ...
    use crate::alexander_ai_solutions::memory_tree::score::extract::ExtractedTopic;
