...
use super::*;
use crate::alexander_ai_solutions::memory::chat::{
    test_override, ChatProvider, StaticChatProvider,
};
use crate::alexander_ai_solutions::memory::tree_source::registry::get_or_create_source_tree;
use crate::alexander_ai_solutions::memory_store::content as content_store;
use crate::alexander_ai_solutions::memory_store::trees::types::TreeKind;
use std::sync::Arc;
...
fn stage_test_chunks(
    cfg: &Config,
    chunks: &[crate::alexander_ai_solutions::memory_store::chunks::types::Chunk],
) {
    ...
    crate::alexander_ai_solutions::memory_store::chunks::store::with_connection(cfg, |conn| {
        let tx = conn.unchecked_transaction()?;
        crate::alexander_ai_solutions::memory_store::chunks::store::upsert_staged_chunks_tx(
            &tx, &staged,
        )?;
        tx.commit()?;
        Ok(())
...
fn seed_doc_chunk(
    ...
    seq: u32,
    content: &str,
) -> crate::alexander_ai_solutions::memory_store::chunks::types::Chunk {
    use crate::alexander_ai_solutions::memory_store::chunks::store::upsert_chunks;
    use crate::alexander_ai_solutions::memory_store::chunks::types::{
...
async fn seal_document_subtree_seals_sibling_batches_concurrently() {
    use crate::alexander_ai_solutions::memory::chat::ChatPrompt;
    use crate::alexander_ai_solutions::memory_store::chunks::store::upsert_chunks;
    use crate::alexander_ai_solutions::memory_store::chunks::types::{
        chunk_id, Chunk, Metadata, SourceKind, SourceRef,
    };
...
async fn fanout_at_l1_triggers_l2_seal() {
    ...
    use crate::alexander_ai_solutions::memory_store::trees::types::SUMMARY_FANOUT;
    use chrono::TimeZone;
...
fn seed_leaf(
    ...
    use crate::alexander_ai_solutions::memory_tree::score::extract::EntityKind;
    use crate::alexander_ai_solutions::memory_tree::score::resolver::CanonicalEntity;
    use crate::alexander_ai_solutions::memory_tree::score::store::index_entity;
    use chrono::TimeZone;
    let ts = Utc
...
async fn seal_with_extract_strategy_populates_entities_and_topics() {
    use crate::alexander_ai_solutions::memory_tree::score::extract::{
        CompositeExtractor, EntityExtractor,
    };
...
async fn topic_tree_seal_persists_topic_kind_not_source() {
    use crate::alexander_ai_solutions::memory_store::trees::types::TreeStatus;
...
fn scope_slug_non_gmail_uses_full_scope() {
    ...
    use crate::alexander_ai_solutions::memory_store::content::paths::slugify_source_id;
...
async fn hydrate_summary_inputs_batch_preserves_order_and_skips_missing_ids() {
    use crate::alexander_ai_solutions::memory_store::content::atomic::stage_summary;
    use crate::alexander_ai_solutions::memory_store::content::SummaryComposeInput;
    use crate::alexander_ai_solutions::memory_store::content::SummaryTreeKind;
    use crate::alexander_ai_solutions::memory_store::trees::store::insert_tree;
    use crate::alexander_ai_solutions::memory_store::trees::types::{
        SummaryNode, Tree, TreeKind, TreeStatus,
    };
    use crate::alexander_ai_solutions::memory_tree::tree::store::insert_summary_tx;
    use chrono::TimeZone;
...
async fn whitespace_llm_summary_falls_back_to_deterministic_content() {
    ...
    let sidecar_embedding =
        crate::alexander_ai_solutions::memory_store::trees::store::get_summary_embedding(
            &cfg, &sealed[0],
        )
        .unwrap();
    assert!(
