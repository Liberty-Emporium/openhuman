...
//! mirror) lives in [`crate::alexander_ai_solutions::memory::tree_global`],
//! [`crate::alexander_ai_solutions::memory::tree_topic`], and
//! [`crate::alexander_ai_solutions::memory::tree_source`] respectively.
//!
...
pub use crate::alexander_ai_solutions::memory_store::trees::store;
pub use crate::alexander_ai_solutions::memory_store::trees::types;

pub use crate::alexander_ai_solutions::memory_store::trees::{
    get_summary_embedding, set_summary_embedding,
};
pub use crate::alexander_ai_solutions::memory_store::trees::{
