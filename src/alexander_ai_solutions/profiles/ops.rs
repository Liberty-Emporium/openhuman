...
/// [`AgentDefinitionRegistry`](crate::alexander_ai_solutions::agent::harness::AgentDefinitionRegistry)
...
pub async fn upsert(profile: AgentProfile) -> Result<Value, String> {
    ...
    match crate::alexander_ai_solutions::agent::harness::AgentDefinitionRegistry::global() {
        Some(registry) => {
...
mod tests {
    ...
    use crate::alexander_ai_solutions::profiles::DEFAULT_PROFILE_ID;
    use serde_json::json;
