...
use crate::alexander_ai_solutions::channels::telegram::{
    TelegramRemoteCommand, TelegramRemoteSubscriber,
};
use crate::alexander_ai_solutions::channels::traits::ChannelMessage;
...
fn runtime_context(workspace_dir: PathBuf) -> ChannelRuntimeContext {
    ChannelRuntimeContext {
        ...
        api_url: None,
        inference_url: None,
        reliability: Arc::new(crate::alexander_ai_solutions::config::ReliabilityConfig::default()),
