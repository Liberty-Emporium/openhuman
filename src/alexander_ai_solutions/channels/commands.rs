...
mod tests {
    ...
    async fn doctor_channels_returns_ok_when_no_channels_are_configured() {
        ...
        config.channels_config = crate::alexander_ai_solutions::config::ChannelsConfig::default();
        doctor_channels(config).await.unwrap();
    }

    #[tokio::test]
    async fn doctor_channels_runs_with_telegram_config() {
        use crate::alexander_ai_solutions::config::{StreamMode, TelegramConfig};
        let mut config = Config::default();
        config.channels_config = crate::alexander_ai_solutions::config::ChannelsConfig::default();
    ...
    async fn doctor_channels_runs_with_discord_config() {
        use crate::alexander_ai_solutions::config::DiscordConfig;
        let mut config = Config::default();
        config.channels_config = crate::alexander_ai_solutions::config::ChannelsConfig::default();
    ...
    async fn doctor_channels_runs_with_slack_config() {
        use crate::alexander_ai_solutions::config::SlackConfig;
        let mut config = Config::default();
        config.channels_config = crate::alexander_ai_solutions::config::ChannelsConfig::default();
    ...
    async fn doctor_channels_runs_with_imessage_config() {
        use crate::alexander_ai_solutions::config::IMessageConfig;
        let mut config = Config::default();
        config.channels_config = crate::alexander_ai_solutions::config::ChannelsConfig::default();
    ...
    async fn doctor_channels_runs_with_multiple_channels() {
        use crate::alexander_ai_solutions::config::{
            DiscordConfig, SlackConfig, StreamMode, TelegramConfig,
        };
        let mut config = Config::default();
        config.channels_config = crate::alexander_ai_solutions::config::ChannelsConfig::default();
        config.channels_config.telegram = Some(TelegramConfig {
