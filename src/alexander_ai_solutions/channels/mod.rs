...
// `crate::alexander_ai_solutions::context::channels_prompt` alongside the rest of
// the prompt-building code. Re-exported here for callers that used the
// old `channels::build_system_prompt` path.
pub use crate::alexander_ai_solutions::context::channels_prompt::build_system_prompt;
