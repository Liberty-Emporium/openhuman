...
pub async fn discord_list_guilds(
    ...
    RpcOutcome<Vec<crate::alexander_ai_solutions::channels::providers::discord::api::DiscordGuild>>,
    String,
> {
    use crate::alexander_ai_solutions::channels::providers::discord::api;
...
pub async fn discord_list_channels(
    ...
    RpcOutcome<
        Vec<crate::alexander_ai_solutions::channels::providers::discord::api::DiscordTextChannel>,
    >,
    String,
> {
    use crate::alexander_ai_solutions::channels::providers::discord::api;
...
pub async fn discord_check_permissions(
    ...
    RpcOutcome<
        crate::alexander_ai_solutions::channels::providers::discord::api::BotPermissionCheck,
    >,
    String,
> {
    use crate::alexander_ai_solutions::channels::providers::discord::api;
