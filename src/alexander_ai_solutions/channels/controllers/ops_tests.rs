use super::*;
use crate::alexander_ai_solutions::channels::email_channel::EmailConfig;
use crate::alexander_ai_solutions::channels::providers::yuanbao::YuanbaoConfig;
use crate::alexander_ai_solutions::config::schema::{
...
async fn channel_status_reports_managed_dm_credential_as_connected() {
    ...
    crate::alexander_ai_solutions::credentials::ops::store_provider_credentials(
        &config,
...
async fn channel_status_surfaces_live_listener_error() {
    ...
    crate::alexander_ai_solutions::health::mark_component_error(
        "channel:discord",
        "gateway closed (4004)",
    );
    ...
    crate::alexander_ai_solutions::health::mark_component_ok("channel:discord");
