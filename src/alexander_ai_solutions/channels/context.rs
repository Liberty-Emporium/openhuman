...
use crate::alexander_ai_solutions::inference::provider::{ChatMessage, Provider};
...
pub(crate) struct ChannelRuntimeContext {
    ...
    pub(crate) reliability: Arc<crate::alexander_ai_solutions::config::ReliabilityConfig>,
    ...
    pub(crate) multimodal: crate::alexander_ai_solutions::config::MultimodalConfig,
    pub(crate) multimodal_files: crate::alexander_ai_solutions::config::MultimodalFileConfig,
}
...
pub(crate) async fn build_memory_context(
    ...
    if let Ok(entries) = mem
        .recall(
            user_msg,
            5,
            crate::alexander_ai_solutions::memory::RecallOpts::default(),
        )
        .await
    {
...
mod tests {
    ...
    use crate::alexander_ai_solutions::memory::{Memory, MemoryCategory, MemoryEntry};
    ...
    fn runtime_context() -> ChannelRuntimeContext {
        ChannelRuntimeContext {
            ...
            inference_url: None,
            reliability: Arc::new(
                crate::alexander_ai_solutions::config::ReliabilityConfig::default(),
            ),
            provider_runtime_options:
                crate::alexander_ai_solutions::inference::provider::ProviderRuntimeOptions::default(
                ),
            workspace_dir: Arc::new(PathBuf::from("/tmp")),
            message_timeout_secs: CHANNEL_MESSAGE_TIMEOUT_SECS,
            multimodal: crate::alexander_ai_solutions::config::MultimodalConfig::default(),
            multimodal_files: crate::alexander_ai_solutions::config::MultimodalFileConfig::default(
            ),
        }
    }
    ...
    fn clear_and_compact_sender_history_update_cached_messages() {
        ...
        history
            .push(crate::alexander_ai_solutions::inference::provider::ChatMessage::user("short"));
