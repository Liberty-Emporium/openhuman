...
use crate::alexander_ai_solutions::channels::providers::web::publish_web_channel_event;
use crate::alexander_ai_solutions::channels::{Channel, SendMessage};
...
#[cfg(not(test))]
fn proactive_approval_gate() -> Option<Arc<crate::alexander_ai_solutions::approval::ApprovalGate>> {
    crate::alexander_ai_solutions::approval::ApprovalGate::try_global()
}
