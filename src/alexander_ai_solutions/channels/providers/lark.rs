use crate::alexander_ai_solutions::channels::traits::{Channel, ChannelMessage, SendMessage};
...
pub struct LarkChannel {
    ...
    receive_mode: crate::alexander_ai_solutions::config::schema::LarkReceiveMode,
...
impl LarkChannel {
    pub fn new(
        ...
        Self {
            ...
            allowed_users,
            use_feishu: true,
            receive_mode: crate::alexander_ai_solutions::config::schema::LarkReceiveMode::default(),
    ...
    pub fn from_config(config: &crate::alexander_ai_solutions::config::schema::LarkConfig) -> Self {
        let mut ch = Self::new(
            config.app_id.clone(),
    ...
    fn http_client(&self) -> reqwest::Client {
        crate::alexander_ai_solutions::config::build_runtime_proxy_client("channel.lark")
    }
...
impl Channel for LarkChannel {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        use crate::alexander_ai_solutions::config::schema::LarkReceiveMode;
