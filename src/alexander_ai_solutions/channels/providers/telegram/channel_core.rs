...
use crate::alexander_ai_solutions::config::{Config, StreamMode};
use crate::alexander_ai_solutions::security::pairing::PairingGuard;
use anyhow::Context;
...
impl TelegramChannel {
    ...
    pub(crate) fn http_client(&self) -> reqwest::Client {
        crate::alexander_ai_solutions::config::build_runtime_proxy_client("channel.telegram")
    }
