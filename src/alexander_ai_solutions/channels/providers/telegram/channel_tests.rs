...
use crate::alexander_ai_solutions::config::StreamMode;
use std::path::Path;
...
async fn test_thinking_placeholder_logic() {
    ...
    use crate::alexander_ai_solutions::channels::traits::Channel;
    ...
    impl Channel for MockTelegramChannel {
        ...
        async fn listen(
            ...
            _: tokio::sync::mpsc::Sender<
                crate::alexander_ai_solutions::channels::traits::ChannelMessage,
            >,
        ) -> anyhow::Result<()> {
            Ok(())
        }
