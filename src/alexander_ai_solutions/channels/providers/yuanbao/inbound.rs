...
mod tests {
    ...
    async fn full_dm_dispatch() {
        ...
        let body = crate::alexander_ai_solutions::channels::providers::yuanbao::proto::encode_msg_body_element(
            &msg.msg_body[0],
        );
        // Synthesize an InboundMessagePush from scratch:
        use crate::alexander_ai_solutions::channels::providers::yuanbao::proto;
        let mut buf = Vec::new();
