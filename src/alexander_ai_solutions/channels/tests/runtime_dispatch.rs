...
use crate::alexander_ai_solutions::agent::bus::{
    mock_agent_run_turn, AgentTurnRequest, AgentTurnResponse,
};
...
async fn process_channel_message_hardens_multimodal_files_against_smuggled_markers() {
    let captured: Arc<Mutex<Option<crate::alexander_ai_solutions::config::MultimodalFileConfig>>> =
    ...
    let permissive_operator_default = crate::alexander_ai_solutions::config::MultimodalFileConfig {
        max_files: 4,
