use super::*;
use crate::alexander_ai_solutions::tokenjuice::rules::load_builtin_rules;
...
fn match_output_pattern_returns_canned_message() {
    use crate::alexander_ai_solutions::tokenjuice::{
    ...
    let rule = crate::alexander_ai_solutions::tokenjuice::types::JsonRule {
    ...
    let compiled = compile_rule(
        rule,
        crate::alexander_ai_solutions::tokenjuice::types::RuleOrigin::Builtin,
...
fn on_empty_returns_custom_message() {
    use crate::alexander_ai_solutions::tokenjuice::{
        rules::compiler::compile_rule, types::RuleMatch,
    };
    ...
    let rule = crate::alexander_ai_solutions::tokenjuice::types::JsonRule {
        ...
        r#match: RuleMatch::default(),
        filters: Some(
            crate::alexander_ai_solutions::tokenjuice::types::RuleFilters {
...
fn pretty_print_json_transform_works() {
    ...
    let rule = crate::alexander_ai_solutions::tokenjuice::types::JsonRule {
        ...
        filters: None,
        transforms: Some(
            crate::alexander_ai_solutions::tokenjuice::types::RuleTransforms {
...
fn head_tail_zero_head() {
    use crate::alexander_ai_solutions::tokenjuice::text::head_tail;
