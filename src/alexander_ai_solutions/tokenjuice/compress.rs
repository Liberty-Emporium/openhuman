...
//!
//! The tool-output adapter [`crate::alexander_ai_solutions::tokenjuice::compact_tool_output`]
//! builds a [`CompressInput`] with a derived command/argv and calls [`route`].

use crate::alexander_ai_solutions::tokenjuice::cache;
use crate::alexander_ai_solutions::tokenjuice::compressors::{compressor_for, generic_compressor};
use crate::alexander_ai_solutions::tokenjuice::detect::detect_content_kind;
use crate::alexander_ai_solutions::tokenjuice::savings;
use crate::alexander_ai_solutions::tokenjuice::tokens::estimate_tokens;
use crate::alexander_ai_solutions::tokenjuice::types::{
...
pub async fn route(mut input: CompressInput<'_>, opts: &CompressOptions) -> CompressedOutput {
    ...
    let primary: Option<
        &'static dyn crate::alexander_ai_solutions::tokenjuice::compressors::Compressor,
    > = match kind {
...
mod tests {
    use super::*;
    use crate::alexander_ai_solutions::tokenjuice::types::CompressorKind;
