...
//! [`crate::alexander_ai_solutions::tokenjuice::ml`]. Whenever the flag is off or the Python
...
impl Compressor for MlTextCompressor {
    ...
    async fn compress(
        ...
        match crate::alexander_ai_solutions::tokenjuice::ml::compress(input.content, opts).await {
