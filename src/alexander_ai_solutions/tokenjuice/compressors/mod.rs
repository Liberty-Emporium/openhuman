...
//! ([`crate::alexander_ai_solutions::tokenjuice::compress`]), which offloads the original to
...
/// — that gating lives in [`crate::alexander_ai_solutions::tokenjuice::compress`], so this
