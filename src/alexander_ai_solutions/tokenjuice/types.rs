...
/// [`crate::alexander_ai_solutions::tokenjuice::compressors::Compressor`] the router picks.
///
...
/// Input handed to a [`crate::alexander_ai_solutions::tokenjuice::compressors::Compressor`].
...
/// retrieval footer — the router ([`crate::alexander_ai_solutions::tokenjuice::compress`])
...
pub struct CompressOptions {
    /// Master switch — when false, [`crate::alexander_ai_solutions::tokenjuice::compress_content`]
    /// is a pass-through.
...
/// The result of the universal [`crate::alexander_ai_solutions::tokenjuice::compress_content`]
