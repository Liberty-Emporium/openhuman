...
use crate::alexander_ai_solutions::runtime_node::types::{ExecuteToolOutcome, RuntimeToolSummary};
use crate::alexander_ai_solutions::security::SecurityPolicy;
use crate::alexander_ai_solutions::tools::{self, Tool, ToolCallOptions, ToolScope};
...
fn build_runtime_tools(config: &Config) -> Result<Vec<Box<dyn Tool>>, String> {
    ...
    let memory: Arc<dyn Memory> = Arc::from(
        crate::alexander_ai_solutions::memory_store::create_memory_with_local_ai(
            &config.memory,
...
mod tests {
    ...
    impl Tool for DummyTool {
        ...
        ) -> anyhow::Result<crate::alexander_ai_solutions::workflows::types::ToolResult> {
            Ok(crate::alexander_ai_solutions::workflows::types::ToolResult::success("ok"))
        }
    }
