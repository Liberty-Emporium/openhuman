...
//! - **User**: `~/.alexanderai/skills/<name>/` or `~/.agents/skills/<name>/`
//! - **Project**: `<workspace>/.alexanderai/skills/<name>/` or
//!   `<workspace>/.agents/skills/<name>/`
//!
//! Project-scope skills are only loaded when a trust marker
//! (`<workspace>/.alexanderai/trust`) is present. When a skill name collides
