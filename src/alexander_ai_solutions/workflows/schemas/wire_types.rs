...
use crate::alexander_ai_solutions::workflows::ops::{
...
pub(super) struct WorkflowsListParams {
    ...
    /// `~/.alexanderai/skills/`) appear in its Installed tab and flip the catalog
...
pub(super) struct WorkflowsRecentRunsResult {
    pub(super) runs: Vec<crate::alexander_ai_solutions::workflows::run_log::ScannedRun>,
}
