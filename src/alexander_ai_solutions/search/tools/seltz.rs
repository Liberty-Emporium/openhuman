...
use crate::alexander_ai_solutions::tools::traits::{Tool, ToolCallOptions, ToolResult};
use crate::alexander_ai_solutions::util::utf8_safe_prefix_at_byte_boundary;
...
impl SeltzSearchTool {
    ...
    fn render_results_plain(&self, docs: &[SeltzDocument], query: &str) -> String {
        ...
        for (i, doc) in docs.iter().take(self.max_results).enumerate() {
            ...
            if !content.is_empty() {
                let truncated =
                    crate::alexander_ai_solutions::util::truncate_with_ellipsis(content, 500);
    ...
    fn render_results_markdown(&self, docs: &[SeltzDocument], query: &str) -> String {
        ...
        for doc in docs.iter().take(self.max_results) {
            ...
            if !content.is_empty() {
                let truncated =
                    crate::alexander_ai_solutions::util::truncate_with_suffix(content, 500, "…");
