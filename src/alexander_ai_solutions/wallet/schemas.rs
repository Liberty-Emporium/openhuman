...
fn handle_status(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        crate::alexander_ai_solutions::wallet::status()
            .await?
...
fn handle_setup(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        crate::alexander_ai_solutions::wallet::setup(WalletSetupParams {
...
fn handle_reveal_recovery_phrase(_params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        crate::alexander_ai_solutions::wallet::reveal_recovery_phrase()
            .await?
            .into_cli_compatible_json()
    })
}
