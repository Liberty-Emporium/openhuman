...
//! `crate::alexander_ai_solutions::inference::voice` so all inference concerns share a
//! single domain root.
...
pub use crate::alexander_ai_solutions::inference::voice::cloud_transcribe;
pub use crate::alexander_ai_solutions::inference::voice::hallucination;
pub use crate::alexander_ai_solutions::inference::voice::local_speech;
pub use crate::alexander_ai_solutions::inference::voice::local_transcribe;
pub use crate::alexander_ai_solutions::inference::voice::postprocess;
pub use crate::alexander_ai_solutions::inference::voice::streaming;
