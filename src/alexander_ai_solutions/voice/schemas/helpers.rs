...
pub(super) fn effective_stt_provider(
    config: &crate::alexander_ai_solutions::config::Config,
) -> String {
    crate::alexander_ai_solutions::voice::effective_stt_provider(config)
}

pub(super) fn effective_tts_provider(
    config: &crate::alexander_ai_solutions::config::Config,
) -> String {
    crate::alexander_ai_solutions::voice::effective_tts_provider(config)
}
...
pub(super) async fn validate_tts_provider_key(
    ...
    let api_key = crate::alexander_ai_solutions::inference::provider::factory::lookup_key_for_slug(
        slug, config,
    )
    .unwrap_or_default();
