...
use super::*;
use crate::alexander_ai_solutions::config::schema::{LocalAiConfig, LocalAiUsage};
...
fn make_legacy_config_local_on() -> Config {
    ...
    c.memory_tree.llm_backend = crate::alexander_ai_solutions::config::schema::LlmBackend::Local;
    c
}
...
fn legacy_inference_url_becomes_custom_entry() {
    ...
    c.model_routes.push(
        crate::alexander_ai_solutions::config::schema::ModelRouteConfig {
            hint: "reasoning".into(),
            model: "gpt-4o".into(),
        },
    );
