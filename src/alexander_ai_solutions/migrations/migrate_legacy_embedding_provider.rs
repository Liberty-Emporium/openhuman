...
//! [`crate::alexander_ai_solutions::embeddings::factory::create_embedding_provider`], which
...
//! existing re-embed backfill ([`crate::alexander_ai_solutions::memory_queue::ensure_reembed_backfill`])
