...
fn handle_status(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let mode = match backend_str {
            ...
            _ => crate::alexander_ai_solutions::agent::harness::definition::SandboxMode::None,
        };
...
fn handle_resolve_policy(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let mode = match mode_str {
            ...
            "read_only" => {
                crate::alexander_ai_solutions::agent::harness::definition::SandboxMode::ReadOnly
            }
            _ => crate::alexander_ai_solutions::agent::harness::definition::SandboxMode::None,
        };

        let config = crate::alexander_ai_solutions::config::RuntimeConfig::default();
        let action_dir = crate::alexander_ai_solutions::config::default_action_dir();
