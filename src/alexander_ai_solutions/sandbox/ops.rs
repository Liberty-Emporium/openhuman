...
use crate::alexander_ai_solutions::cwd_jail::{self, Jail, NoopBackend};
...
pub async fn execute_in_sandbox(
    ...
    match policy.backend {
        SandboxBackendKind::None => {
            crate::alexander_ai_solutions::config::ensure_usable_cwd(working_dir)?;
        ...
        SandboxBackendKind::Docker => {
            crate::alexander_ai_solutions::config::ensure_usable_cwd(&policy.workspace_root)?;
