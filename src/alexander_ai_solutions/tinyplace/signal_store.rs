...
//!   [`crate::alexander_ai_solutions::keyring::SecretStore`] (ChaCha20-Poly1305, OS keychain
...
async fn init_signal_store() -> std::result::Result<Arc<FileSessionStore>, String> {
    ...
    let seed = crate::alexander_ai_solutions::wallet::tinyplace_signer_seed().await?;
    ...
    //    of `config_path` (e.g. `~/.alexanderai/users/<id>/`).
