...
//! process-global accessor for [`crate::alexander_ai_solutions::tinyplace::state::TinyPlaceState`].

use std::sync::OnceLock;

use crate::alexander_ai_solutions::tinyplace::state::TinyPlaceState;
