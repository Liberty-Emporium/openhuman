...
use crate::alexander_ai_solutions::app_state::peek_cached_current_user_identity;
use crate::alexander_ai_solutions::config::rpc as config_rpc;
use crate::alexander_ai_solutions::notifications::bus::publish_core_notification;
...
pub(crate) fn auto_join_policy_owns_notification(
    policy: &crate::alexander_ai_solutions::config::schema::AutoJoinPolicy,
) -> bool {
    use crate::alexander_ai_solutions::config::schema::AutoJoinPolicy;
...
pub async fn handle_calendar_meeting_candidate(
    ...
    match config.meet.auto_join_policy {
        crate::alexander_ai_solutions::config::schema::AutoJoinPolicy::Never => {
        ...
        crate::alexander_ai_solutions::config::schema::AutoJoinPolicy::AskEachTime => {
