...
use crate::alexander_ai_solutions::inference::provider::create_chat_provider;
...
mod tests {
    ...
    impl crate::alexander_ai_solutions::inference::provider::Provider for ScriptedProvider {
    ...
    async fn generate_meeting_summary_parses_and_maps_provider_reply() {
        ...
        let _guard =
            crate::alexander_ai_solutions::inference::provider::factory::test_provider_override::install(
