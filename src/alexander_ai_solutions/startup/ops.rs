...
pub fn run_workspace_migrations(workspace_dir: &Path) {
    match crate::alexander_ai_solutions::agent::harness::session::migrate_session_layout_if_needed(
        workspace_dir,
    ) {
    ...
    match crate::alexander_ai_solutions::threads::migrate_welcome_agent_artifacts(workspace_dir) {
