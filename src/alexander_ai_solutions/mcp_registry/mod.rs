...
//! registry ([`crate::alexander_ai_solutions::tool_registry`]).
//!
...
//!
//! The sibling [`crate::alexander_ai_solutions::mcp_client`] module is the **transport
...
//!   [`crate::alexander_ai_solutions::mcp_client::McpStdioClient`] — there is no
