...
async fn invoke_config_assist_agent(
    ...
    let mut agent = match crate::alexander_ai_solutions::agent::Agent::from_config(config) {
        Ok(a) => a,
        Err(e) => {
            return Ok(json!({
                "reply": format!(
    ...
    let reply_result = crate::alexander_ai_solutions::agent::turn_origin::with_origin(
...
mod tests {
    ...
    fn collect_required_env_keys_from_schema() {
        use crate::alexander_ai_solutions::mcp_registry::types::{
            SmitheryConnection, SmitheryServerDetail,
        };
        ...
        let keys =
            crate::alexander_ai_solutions::mcp_registry::setup_ops::collect_required_env_keys(
                &detail,
            );
    ...
    fn resolve_command_with_example_config() {
        use crate::alexander_ai_solutions::mcp_registry::types::SmitheryConnection;
