//! Compat shim — prompt plumbing has moved to [`crate::alexander_ai_solutions::agent::prompts`].
//!
...
//! the rest of the tree — `use crate::alexander_ai_solutions::context::prompt::...`
//! keeps working unchanged.

pub use crate::alexander_ai_solutions::agent::prompts::*;
