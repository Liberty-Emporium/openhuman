...
//!    [`crate::alexander_ai_solutions::context::session_memory`].
//!
//! # Cache contract
//!
...
use crate::alexander_ai_solutions::inference::provider::{ConversationMessage, UsageInfo};
...
impl ContextPipeline {
    ...
    /// observability / [`crate::alexander_ai_solutions::context::ContextStats`].
