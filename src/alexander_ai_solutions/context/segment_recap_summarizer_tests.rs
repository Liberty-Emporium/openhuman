...
use crate::alexander_ai_solutions::agent::hooks::{PostTurnHook as _, TurnContext};
use crate::alexander_ai_solutions::context::summarizer::{Summarizer, SummaryStats};
use crate::alexander_ai_solutions::inference::provider::{ChatMessage, ConversationMessage};
use crate::alexander_ai_solutions::memory::chat::ChatPrompt;
use crate::alexander_ai_solutions::memory_store::{fts5, segments as seg};
use anyhow::Result;
...
fn setup_conn() -> Arc<Mutex<Connection>> {
    ...
    conn.execute_batch(crate::alexander_ai_solutions::memory_store::events::EVENTS_INIT_SQL)
        .unwrap();
    conn.execute_batch(crate::alexander_ai_solutions::memory_store::profile::PROFILE_INIT_SQL)
        .unwrap();
...
#[async_trait]
impl crate::alexander_ai_solutions::memory::chat::ChatProvider for StubChatProvider {
    fn name(&self) -> &str {
        "stub:test"
    }
...
#[async_trait]
impl crate::alexander_ai_solutions::memory::chat::ChatProvider for FailingChatProvider {
    fn name(&self) -> &str {
        "stub:failing"
    }
    async fn chat_for_json(&self, _prompt: &ChatPrompt) -> Result<String> {
...
#[async_trait]
impl crate::alexander_ai_solutions::memory_tree::score::embed::Embedder for StubEmbedder {
