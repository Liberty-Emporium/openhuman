...
//!
//! All public functions delegate to the active backend selected by [`crate::alexander_ai_solutions::keyring::store`].
...
use crate::alexander_ai_solutions::keyring::store::backend;
...
pub(crate) fn force_backend_for_test(
    b: Box<dyn crate::alexander_ai_solutions::keyring::backend::KeyringBackend>,
) {
    use crate::alexander_ai_solutions::keyring::store::BACKEND;
