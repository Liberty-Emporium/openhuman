...
- **`workspace_dir`** — internal state (`~/.alexanderai/users/<id>/workspace`). Agent tools **cannot** write here — enforced by `is_workspace_internal_path` fail-closed regardless of tier/trusted_roots.
